/** Articles for days 11-15. */
export const DAYS_11_15: Record<string, string> = {
  'how-long-to-learn-touch-typing': `
For an adult practising fifteen minutes a day, typing without looking at the keyboard usually takes two to three weeks, returning to your previous speed takes four to eight weeks, and comfortable fluency with punctuation and numbers takes three to six months. Those are four different milestones, and most of the confusion about "how long it takes" comes from treating them as one. Here is what each involves and what changes the answer.

## Four milestones, not one

When someone says they learned to touch type in a fortnight and someone else says it took them a year, they are usually both telling the truth about different things.

| Milestone | Typical time, 15 min/day | What it means |
|---|---|---|
| Home row and the return habit | 2–4 days | Fingers find A S D F / J K L ; by feel |
| All letters placed correctly | 1–2 weeks | You know which finger does what, slowly |
...
### How often you practise, not how much

Fifteen minutes a day beats an hour twice a week, for the same total time, and it is not close.

Motor skills consolidate *between* practice sessions rather than during them, including during sleep. Five short sessions give you five consolidations; two long ones give you two. This is one of the better-established findings in motor learning research, and it is the reason every timeline in this article is expressed in daily terms.

The practical implication: if you can only manage ten minutes, do ten minutes. Skipping because you do not have half an hour is the most common way this goes wrong.

### Whether you cover your hands

People who cover their hands from the first session reach the "typing without looking" milestone in two to three weeks. People who intend to stop looking once they feel ready frequently never get there at all, because looking down is always faster today.

This single decision probably accounts for more variance in outcomes than talent, age and practice time combined.
...
**Days 1–4.** Tedious rather than hard. Home row only, returning to position after every key. It feels like it cannot possibly be the real thing. It is.
...
**Weeks 4–8.** Speed climbs back. Capitals and punctuation are the drag now. This is the point to start deliberately drilling the opposite-hand shift, because a same-hand shift habit formed here is tedious to remove later.

**Months 3–6.** It becomes invisible. You will notice one day that you typed a paragraph while thinking about something else, which is the actual goal.
...
Four things genuinely compress the timeline:

1. **Cover your hands from session one.** Not once you feel ready.
2. **Practise daily, even briefly.** Frequency beats duration.
...
You can learn the finger assignments in a week and type slowly without looking. You will not be fluent, and you will not be back to your old speed. Anyone promising fluency in a week is describing the first milestone and calling it the last.

### How many hours does it take in total?

Roughly ten to fifteen hours of practice to stop looking, and something like forty to sixty to become genuinely fluent. But the hours are less useful than the calendar, because the same hours spread over more days produce a better result.
...
Partial touch typing is the worst place to stop: slower than your old method and not yet fluent. The technique does not vanish, but the habit will revert under pressure within a few weeks. If you are going to start, plan for six weeks rather than two.

### Does it get easier or harder as you go?

Easier in effort and slower in visible progress. The first fortnight is the hardest and produces the most obvious gains; month four is comfortable and produces changes you can barely see week to week.

## Start the clock

The first milestone is four days away, and it is the one that makes the rest possible: home row, hands covered, returning to position after every key.

If you already type reasonably well, do not start at lesson one. KeyTopia's [60-second placement test](/typing-test) reads your current technique and opens the [curriculum](/curriculum) where the actual gap is, which is usually several weeks further in than a beginner course would put you.
`,

  'home-row-keys': `
The home row is the middle row of letter keys where your fingers rest between keystrokes: **A S D F** under the left hand and **J K L ;** under the right, with both thumbs on the space bar. The small raised ridges on the F and J keys exist so you can find this position without looking. Everything else in touch typing is defined as a movement away from the home row and back to it.
...
- **Thumbs:** resting lightly on the space bar

Your fingers should be gently curved, as though holding a small ball, with the fingertips on the keys rather than the pads. Your wrists should float rather than rest on the desk.

That last point matters more than it sounds. A wrist resting on the desk anchors the hand, so reaching for a key in the row above becomes a stretch of the finger against a fixed hand instead of a small, easy extension. It is a common cause of both slowness and discomfort. Rest between bursts, not during them.

## Why this row, and why it works

Three reasons, and they are worth knowing because they explain a lot of what follows.

**It is the middle.** Every other letter is one row up or one row down, so no key is more than a short reach from a resting finger. A home position on the top or bottom row would make every reach in one direction twice as long.

**It gives you a positional reference.** This is the important one. Touch typing works because your fingers know where they are relative to a known point. Lose the reference and you are guessing; keep returning to it and every reach starts from the same place and can become the same movement every time.

**It puts common letters under resting fingers.** A, S, D, E-adjacent, and the whole right-hand cluster of J K L are all high-frequency in English, so a significant proportion of your keystrokes require no reach at all.

## The habit that actually matters: returning
...
> If you practise one thing this week, practise the return. Type a home-row letter, then a reach, then a home-row letter, and notice whether your finger came back on its own. Most people find it does not, at first.

## What you can type without leaving the row
...
Practise this deliberately: take your hands off the keyboard entirely, then put them back and type a word, without looking. Ten repetitions of that is a genuinely useful exercise and almost nobody does it.

## Other layouts, other home rows
...
**Resting the wrists on the desk.** Anchors the hand and turns reaches into stretches.

**Letting the little fingers hover instead of resting.** A and the semicolon are their home keys; if the little fingers are held above the keyboard, the whole hand position drifts.

**Flattening the fingers.** Straight fingers reach badly and press with the pads rather than the tips. Curve them.

**Looking down to re-find position.** The single most common way the whole habit unravels.

**Adding letters too quickly.** If the return is not automatic yet, adding E and I will simply produce two more keys typed without a return.

The full picture of which finger owns which key, once you leave the row, is in [correct finger placement for touch typing](/blog/correct-finger-placement-for-touch-typing).

## Common questions

### What are the bumps on F and J for?

Exactly this: locating the home row by touch. They are a deliberate standard feature, not a manufacturing artefact. Some keyboards also put a ridge on the 5 of the number pad, for the same reason.
...
Both rest there; most people press with one, usually the dominant hand's. Either is fine as long as it is consistent, because consistency is what allows the movement to become automatic.
...
Cover your hands. Find the ridges on F and J. Type these words, returning every finger to its home key after each letter:

*ask, all, lads, flask, salad, falls, dads, glass*

Then take your hands off the keyboard, put them back without looking, and do it again.

That is the whole first stage, and doing it properly for a few days makes everything after it considerably easier. When the return has become automatic, our [beginner's guide to touch typing](/blog/how-to-learn-touch-typing) sets out the order to add the rest of the alphabet in.
`,
...
The arithmetic is the whole argument, and most people have never done it.
...
Two opposing effects define it.

**Below about 95%**, errors are frequent enough that the correction overhead dominates. You are typing fast and producing text slowly. Every point of accuracy you gain here is worth more than the speed you give up to get it.
...
|---|---|---|
| Below 90% | Errors dominate; likely a technique fault | Slow down hard, check finger assignments |
| 90–95% | Correction overhead is eating your speed | Accuracy work, at 80% of top pace |
| 96–98% | The productive band | Push speed gradually |
| Above 99% | Probably over-cautious | Speed up until accuracy drops into the band |

That last row surprises people. Sustained accuracy above 99% at a comfortable pace usually means you are leaving speed on the table.

## Why accuracy has to come first, mechanically
...
The reverse works: speed built on a reliable movement arrives more or less on its own, because a movement that is repeated accurately gets faster with repetition. You do not have to train it directly nearly as much as people assume.

## How to work out which to train

Take one test at your normal working pace, and look at three numbers.

**If accuracy is below 95%:** train accuracy. Type at about 80% of your top speed and hold it there. The goal is a session where you barely use backspace.

**If accuracy is 96–98% and your speed is stable:** train speed, in short bursts, and accept a temporary dip in accuracy during those bursts only.
...
- **Drill the specific errors, not accuracy in general.** Ten minutes on the four transitions that produce a third of your mistakes beats an hour of careful general typing.
- **Watch what degrades as you tire.** Most people's accuracy is fine for a minute and falls apart at four. If that is you, your problem is endurance and posture, not precision.

There is a fuller method in [how to improve typing accuracy without slowing down](/blog/improve-typing-accuracy).

## Training speed without wrecking accuracy

Once you are in the band:

- **Use short bursts.** Fifteen to thirty seconds above comfortable pace, then back down. Sustained over-pace typing rehearses errors.
- **Push on easy material.** Speed work on common words builds the whole-word patterns that make typing feel fast. Speed work on difficult material mostly produces mistakes.
- **Alternate.** A speed session followed by an accuracy session works better than either alone, because the speed session shows you what breaks and the accuracy session repairs it.
- **Measure weekly, not daily.** Daily measurement shows noise. Weekly shows the trend.

## The case for a third measure

Speed and accuracy are the two numbers everyone quotes, and there is a third that predicts improvement better than either: **consistency**, meaning how even the intervals between your keystrokes are.
...
It is borderline. At 95% you are making roughly one error every twenty keystrokes, which is about one per four or five words. That is frequent enough that correction overhead is noticeably reducing your net speed. Aim for 97%.

### My accuracy is high but my speed is stuck. What now?

Almost certainly specific transitions rather than general slowness, or excessive caution. Push the pace deliberately and see whether accuracy holds; if it does, you were being too careful. If it collapses on particular letter pairs, those pairs are your practice list. [How to reach 100 WPM](/blog/how-to-reach-100-wpm) covers this level.

### Does accuracy matter if I can type fast and fix it afterwards?

Only if you never have to read what you produced. Fixing afterwards means re-reading, which costs more time than the errors did, and it means the error rate compounds into anything you send unchecked.
...
Most children are ready to learn proper touch typing between the ages of seven and nine. The deciding factor is hand size, not birthday: a child needs to span the home row and reach the top row without shifting their whole hand. Before that, keyboard familiarity is the right goal. This article gives the readiness test, what to do at each age, and why starting too early can create a habit you later have to undo.

## The readiness test

It takes thirty seconds and it is more reliable than any age guideline.

**Sit your child at the keyboard. Ask them to put their left-hand fingers on A, S, D and F, and their right-hand fingers on J, K, L and the semicolon. Then ask them to reach up and press E with the finger that is on D, and come back.**
...
### Ages 4–6: familiarity, not technique

No finger assignments, no home row rules, no correction.

The goal at this age is simply that a keyboard is an ordinary object rather than a puzzle: that letters have places, that pressing a key produces that letter, that the space bar makes a gap. Typing their own name is a genuinely useful milestone.

Games that ask for one letter at a time are ideal here, because they build letter recognition and hand-eye coordination without demanding a hand span the child does not have. Anything demanding speed is counterproductive.

### Ages 6–7: the idea of two hands

Introduce one concept and stop: **the left hand looks after the left side of the keyboard, and the right hand looks after the right**.

Show them the ridges on F and J and let it be a small secret rather than a rule. Do not enforce full finger assignment yet. Many children in this band can manage the home row comfortably and some cannot, so run the readiness test rather than assuming.

### Ages 7–9: the main window

This is where proper touch typing usually belongs. Most children can span the home row comfortably, can read fluently enough to work from text, and can sustain a ten-minute session.
...
Effectively the adult process. Worth doing before coursework and exams start being produced under time pressure, because at that point a slow typist is disadvantaged on tasks meant to assess something else entirely.

The approach is the one in [learning touch typing as an adult](/blog/learn-touch-typing-as-an-adult): ring-fence practice from real work for the first fortnight, then migrate across.
...
None of these argue against keyboard *exposure* early. They argue against formal technique training early.

## Why not wait until secondary school?
...
Seven to nine is the window where it is cheapest. Later is still worth doing.

## What to do while you wait

If your child is keen but not physically ready, this is genuinely useful:

- **Letter-finding games.** One letter at a time, no time pressure, no finger rules.
- **Typing their name, and short familiar words.** Real, motivating, and no technique burden.
- **Naming the hands.** "That letter lives on the left" builds the split without demanding the span.
- **Leaving the keyboard alone otherwise.** There is no benefit in practising a technique they cannot yet perform.

Then re-run the readiness test every couple of months. The change, when it comes, is usually noticeable.

## The one thing worth getting right early

Whenever you start, start with the hands covered.

A child who learns to type while looking at the keys is learning a visually guided skill, and switching later means learning the whole thing again. Children accept a tea towel over their hands far more readily than adults do, provided it is simply how typing has always worked rather than a restriction introduced once they are comfortable looking down.

This single decision matters more than the starting age.

## Common questions

### Is there a best age to learn typing?

Seven to nine for most children, but readiness matters more than the number. A physically ready six year old will do better than an unready eight year old, and the readiness test above settles it in half a minute.

### My five year old wants to learn properly. Should I let them?

Let them play with the keyboard as much as they like. Do not impose finger assignments if their hand shifts to reach, because that teaches a habit you will have to remove. Enthusiasm is worth preserving; technique can wait a year.

### Will learning early make them faster later?

Only if the technique is correct. Early practice with a shifting hand or two fingers builds a habit rather than a foundation, and it makes the eventual transition harder rather than easier.
...
Sit them down, ask for the home row, and watch whether the hand stays put on a reach to E.
...
Five design choices inflate typing scores, and most tests make at least two of them.

**Short duration.** A fifteen-second test extrapolates your best burst by a factor of four. You can hold well above your sustainable pace for ten seconds; you cannot for two minutes. Short tests measure your peak, not your typing.

**Common words.** A test drawing from the two hundred most frequent English words produces a much higher score than one drawing from ten thousand. Common words are short, familiar, and mostly alternate hands.

**Familiar passages.** Repeat the same text and you are increasingly measuring recall. Some sites reuse a small pool of passages, so a regular visitor is quietly measuring memory.
...
## A protocol that gives you a usable number

Follow this and your result will be boring, stable, and actually predictive.
...
The median of three across days removes the two biggest sources of noise: how alert you are, and the luck of the passage.

## Conditions that quietly change your result

Control these, or at least keep them the same between tests, because each is worth several words per minute.

- **The keyboard.** Key travel, spacing and force differ enough between boards that switching costs most people a noticeable amount for a few minutes. Test on the keyboard you actually work on.
- **Sitting position.** A laptop on your knees produces a different result from a desk setup. [Typing posture](/blog/typing-posture) covers why.
- **Time of day and fatigue.** Typing speed varies through the day more than people expect.
- **Whether anyone is watching.** Being observed reliably disrupts automatic skills.
- **The screen showing your errors in real time.** Some people speed up with live feedback and some are derailed by it.

## Read all four numbers, not one

A good test gives you more than a headline. Each number answers a different question.

| Number | What it tells you |
|---|---|
| Net speed | How fast you produce usable text. The headline. |
| Raw (gross) speed | How fast your fingers moved, errors included |
...
If your test also reports **per-key timing**, that is where the actionable detail lives. An average cannot tell you that a third of your lost time sits on four letters; a per-key breakdown can, and it converts "practise more" into a specific list.

## Testing for a job application

If you are being tested for a role, the conditions will not be yours to choose, so prepare for the awkward ones.
...
Where employers state a requirement it is commonly in the 40 to 60 words per minute range for general administrative work, and higher for transcription and data entry. [What is a good typing speed](/blog/what-is-a-good-typing-speed) puts those figures in context.
...
More on this in [what is a good typing speed for kids](/blog/typing-speed-for-kids-by-age).

## Common questions

### How often should I test myself?

Weekly, at most, if you are training. Daily testing shows day-to-day noise rather than progress and tends to make people anxious about a number that moves for reasons unrelated to their typing.

### Should I take my best score or my average?

Your median across several attempts. Your best score is your best minute, which is not a description of your typing and is not what you should plan around.
