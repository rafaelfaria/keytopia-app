...
## The four error types, and what each one means

### Substitutions: the wrong letter entirely

You typed R instead of T, or D instead of S. Almost always an **adjacent key** on the same finger's column or a neighbouring one.

Cause: the finger is not returning fully to home, so each reach starts from slightly the wrong place and the error accumulates over a few keystrokes.

Fix: drill the return. Type a home-row letter, then the problem letter, then a home-row letter, slowly, checking that the finger comes back every time.

### Transpositions: right letters, wrong order

Typing "teh" for "the", or "adn" for "and". These are overwhelmingly **alternating-hand sequences**, and they are a timing fault rather than a targeting fault: both hands moved, and one arrived early.

Cause: you are typing faster than your hands are coordinated on that specific sequence, usually a very common word where the whole pattern has become automatic before the timing settled.

Fix: drill the specific word at a deliberately even pace. Transposition errors respond very well to targeted practice because there are usually only a handful of offending words.
...
Fix: relax the hand first, then drill the specific finger. Two weeks of deliberate use is usually enough for a little finger to stop dropping keys.

### Insertions: an extra letter

Often a **doubled letter** where you typed one, or a neighbouring key caught by the side of the finger.

Cause: usually flat fingers pressing with the pad rather than the tip, or excessive key force.

Fix: curve the fingers, press more lightly.

## Drills that fix accuracy without costing speed
...
If your accuracy has been stuck for months, the cause is usually structural rather than a matter of care. Check these:

- **Not returning to the home row.** The single most common cause of substitution errors. Every reach should end with the finger back on its home key.
- **Wrong finger assignments.** C typed with the index finger, B and Y taken by whichever hand is free. An improvised assignment changes depending on the previous letter, so it never becomes reliable. See [correct finger placement](/blog/correct-finger-placement-for-touch-typing).
- **Same-hand shift.** Left shift with a left-hand letter is a stretch with the hand locked, and it produces errors on the letter itself as well as being slow.
- **Wrists resting on the desk.** Anchors the hand, turning reaches into stretches and pulling the fingers off target.
- **Gripping the keyboard.** Tension makes the weak fingers weaker and the return stroke slower.

Fix these in order of how often the offending letters appear in your typing. Fixing the assignment for C is worth more than fixing the one for Z.

## How accurate should you actually be?
...
> One caveat on the average. A 97% overall figure can hide 88% on four particular transitions, and an average that healthy will not prompt you to look. This is why the per-key breakdown matters more than the headline once you are past the beginner stage.

## A two-week accuracy plan

**Days 1–2.** Take one test at your normal pace. Record accuracy, and the keys and transitions with the highest error rates. Do no training.

**Days 3–7.** Ten minutes daily: five minutes on your three worst transitions, five minutes of real prose at 80% pace, no corrections.

**Days 8–12.** Same, but add capitals and punctuation into the prose. These are where accuracy commonly falls apart in real writing and almost never in drills.

**Days 13–14.** Retest at your normal pace. Compare accuracy *and* net speed. If accuracy rose and net speed rose too, the errors were the constraint and you have found free speed.

## Common questions

### Will slowing down permanently make me more accurate?

It will while you are slow. The gains do not survive returning to normal pace unless you fixed the underlying cause, which is why targeted work beats general caution beyond the beginner stage.
...
Attending consciously to an automatic skill disrupts it. This is well documented across skilled movements, and it is why performance under observation feels harder. It fades with familiarity but never entirely.
...
Only if they reward it. A game that rewards speed above all else rewards typing faster than you can control, which rehearses errors. A game that ends your run on a mistake trains accuracy effectively. The mechanic is what teaches, not the theme.

## Find your cluster

Take one test at your ordinary working pace and look past the accuracy percentage to the breakdown: which keys, and which transitions, produced the errors.

There will be fewer than you expect, and they will be specific. That short list is a two-week practice plan, and it is a far smaller problem than "be more accurate".

KeyTopia's [typing test](/typing-test) reports per-key error rates and the slowest letter transitions, and its [adaptive practice](/adaptive-practice) builds the drills from exactly that data rather than from a generic exercise set.
`,

  'stop-looking-at-the-keyboard': `
The way to stop looking at the keyboard is to make looking impossible rather than to decide against it. Cover your hands, from your very first session. Willpower fails at this reliably, and for a good reason: looking down is genuinely faster today, so every time you rely on resolve you are asking yourself to choose the slower option while under time pressure. Remove the option and the problem solves itself in about two to three weeks.

## Why you keep looking even when you mean not to

It is not a character failing. It is short-term optimisation working exactly as it should.
...
Work through these in order. Do not skip to the top rung, and do not linger on the bottom one.

### Rung 1: Cover your hands (days 1–14)
...
### Rung 2: Look at the source, not the screen (days 7 onwards)

Once your hands are covered, a second habit usually appears: checking the screen after every word to see whether it came out right.

This is the same problem wearing a different coat. Your eyes are still leaving the text and returning, and you are still confirming rather than trusting.

The fix is to keep your eyes on the text you are copying and let errors accumulate. Read a line, type it, read the next. You will find mistakes at the end; that is fine, and noticing them at the end is much cheaper than checking continuously.
...
### Rung 4: Full sentences, blind (weeks 3–4)

Type a complete sentence, including its capital and its full stop, without looking at either your hands or the screen. Then look.

The capital is the interesting part. Most people who have stopped looking for letters still glance down for shift, and the [opposite-hand shift habit](/blog/correct-finger-placement-for-touch-typing) is worth establishing here rather than later.
...
| Week | Speed | What is happening |
|---|---|---|
| 1 | Roughly half your usual | Every key is a deliberate act. Genuinely unpleasant. |
| 2 | Still well below | Common letters arrive on their own; rare ones do not. |
| 3 | Approaching normal | You stop noticing that you are not looking. |
| 4+ | Normal, then better | The cover becomes unnecessary. |

The first week is the whole difficulty. Knowing in advance that it is supposed to feel like that is most of what gets people through it.

## The specific letters that send your eyes down
...
Each of these is worth a short dedicated drill, because they are the residue that keeps the old habit alive. Type a paragraph containing plenty of apostrophes and question marks and see whether your eyes stay up.

## If you have been typing for twenty years

The method is the same and the fortnight is harder, because you are replacing a habit that works rather than filling a gap. Two adjustments:
...
Children take to this far more easily than adults, on one condition: **it has to be how typing has always worked**, not a restriction introduced once they are comfortable looking down.

A child who has been typing while looking for two years will resist the cover exactly as an adult does. A child who has never typed any other way will not think it strange at all. If you are starting a child on typing, start with the cover on day one.

[Helping kids stop typing with two fingers](/blog/kids-typing-with-two-fingers) covers the related habit, which usually travels with this one.
...
Some people do. Many more intend to and do not. Given that a tea towel costs nothing and removes the single biggest obstacle, the case for going without is weak.

### Is it normal to feel much worse for the first week?

Yes, and it is the most common reason people give up. Your speed will roughly halve. It comes back within three to four weeks and then keeps going past where it was, which the old method would not have done.
...
At the source, in practice. In real work, at whatever you are composing from. What matters is that your eyes are not travelling to your hands and back; where else they rest is much less important.

## Cover your hands tonight

Find a tea towel. Put it over your hands. Type the alphabet slowly, returning each finger to its home key after every letter.

It will be slow and it will feel ridiculous. Do it again tomorrow, and by the end of a fortnight the towel will be unnecessary.

If you want the letters introduced in a sensible order while you do it, KeyTopia's [curriculum](/curriculum) adds them by frequency and reach rather than alphabetically, and there is a lights-out practice mode that hides the on-screen keyboard hints for exactly this stage.
`,

  'typing-for-students': `
For students, the value of typing quickly is not that essays get finished sooner. It is that a student who does not have to think about typing has more attention left for what they are writing. That matters most in exactly the situations where attention is scarcest: live lecture notes, timed written exams, and long pieces of coursework. This guide covers where keyboard skills genuinely change outcomes, where they do not, and what speed is actually enough.
...
When typing becomes automatic, that competition disappears. This is why the benefit shows up most clearly in demanding writing tasks rather than in short ones, and why the effect is easy to underestimate if you only think in words per minute.
...
A different profile: shorter bursts, far more symbols and punctuation, constant switching between typing and thinking. Raw prose speed matters less than symbol fluency and never looking down. [Touch typing for programmers](/blog/touch-typing-for-programmers) covers this properly.

## Where it does not matter much

Worth being honest about, because overselling this is how students end up practising the wrong thing.

- **Short answers and problem sets.** If you are writing two sentences, typing speed is irrelevant.
- **Maths, diagrams and lab work.** Mostly not keyboard tasks at all.
- **Anything where you are thinking harder than you are writing.** Past roughly 70 to 80 words per minute, thinking is the constraint for almost everyone. Getting from 80 to 100 is a pleasant achievement with very little academic return.
- **Reading and research**, which is most of study.

## What speed is enough

| Task | Workable | Comfortable |
|---|---|---|
| Homework and short assignments | 30 wpm | 40 wpm |
| Essays and coursework | 40 wpm | 55 wpm |
| Timed written exams | 45 wpm | 60 wpm |
...
## What to actually practise, around a full timetable

Students have less spare time than almost anyone, so the plan has to be small.

**Fifteen minutes a day for six weeks, then stop.** Typing is one of the few skills where a short, finite project genuinely finishes. Once it is automatic, it stays.

**Do it in term time, not in the holidays.** Motor skills consolidate between sessions, so daily practice during a busy term beats a concentrated week off. The daily habit is also easier to attach to an existing routine.

**Split each session three ways:** five minutes on your specific weak keys, seven minutes of real prose with full punctuation, three minutes on capitals or numbers.

**Practise with punctuation from the start.** Academic writing is full of commas, semicolons, brackets, quotation marks and apostrophes. Word-list practice teaches none of them, and they are where student typing usually falls apart.

**Learn the shortcuts that matter for writing:** word-delete, select-word, jump-by-word, and your referencing tool's insert-citation shortcut. These save more time in a long essay than ten extra words per minute would.
...
### Should I type or handwrite my lecture notes?

The research is genuinely mixed, and the widely cited finding that handwriting is better has had a complicated replication history. What is clearer is that *how* you take notes matters more than the medium: summarising in your own words beats verbatim transcription either way. [Typing vs handwriting](/blog/typing-vs-handwriting) sets out what the studies actually found.
...
Around 50 to 60 words per minute covers everything comfortably, including lecture notes. Below 40 you will feel it during timed work.

### Is it worth learning if I already type at 45 with two fingers?

Yes, if you have a year or more of study left. Two-finger typing tops out around 35 to 40 for most people and requires looking down, which is the attention cost that matters. Touch typing keeps improving for years.

### What about exams where I have to handwrite?

Then handwriting speed and legibility are the relevant skills and typing practice will not help. Check your institution's arrangements before deciding where to put your effort.
...
`,
  ...
  'typing-speed-for-kids-by-age': `
Typing speed targets for children are conventions used by schools, not measurements of what children actually do. They are useful as a rough direction of travel and misleading as a verdict on any individual child. Broadly, schools expect a slow start in the early primary years rising to somewhere in the region of 15 to 25 words per minute by the end of primary schooling. What matters far more before about age eleven is whether a child is looking at the keyboard.

## Where these numbers come from, and what they are worth

This section is the important one, because almost every article on this topic presents a confident table without saying where it came from.
...
So: treat targets as targets. A child below one is not behind in any meaningful sense, and a child above one has not proved anything much either.

## A rough guide, honestly labelled

The figures below reflect the kind of progression commonly used in school typing schemes. Read them as "what a school programme tends to aim for", not "what children of this age type".

| Age / school year | Typical target | What actually matters at this stage |
|---|---|---|
| 5–6 (Reception/Year 1) | No speed target | Finding letters; the keyboard being unremarkable |
| 6–7 (Year 2) | Around 5–8 wpm | Left hand / right hand; the F and J bumps |
| 7–8 (Year 3) | Around 8–12 wpm | Home row, correct fingers, hands covered |
| 8–9 (Year 4) | Around 10–15 wpm | Not looking down; accuracy over speed |
| 9–10 (Year 5) | Around 12–20 wpm | Capitals with opposite-hand shift; punctuation |
| 10–11 (Year 6) | Around 15–25 wpm | Sustained typing for several minutes |
| 11–14 | Around 25–40 wpm | Real work at length; numbers |
| 14+ | 40+ wpm | Exam and coursework conditions |

The right-hand column is the one to pay attention to. It is a description of technique milestones, and unlike the speed column it is actually diagnostic.

## Why speed is the wrong measure before about eleven

Three reasons.

**Reading speed is the real limit.** A child copying text is reading it first. For a seven year old, the bottleneck is usually decoding the words, not moving the fingers. You are measuring reading and calling it typing.
...
1. **Are they looking at the keyboard?** This single fact predicts where they will end up better than any speed figure.
2. **Are the right fingers doing the work?** Watch specifically for the little fingers being skipped, C typed with the index finger, and B and Y grabbed by whichever hand is free.
3. **Is accuracy steady?** A consistent 95% at a slow pace is a far better sign than an erratic mixture of fast and wrong.
4. **Can they sustain it?** Thirty seconds of good typing is a start; three minutes is the skill.

If all four are healthy, the speed will arrive on its own. If they are not, speed practice will simply entrench the problem.

## Comparing your child to the targets

Some practical framing for the conversation you are probably having with yourself.
...
**If they are well below and struggling physically:** check hand size. If their hand shifts position to reach the top row, they are not ready, and practice will teach a habit rather than a skill. [What age should kids learn to type](/blog/what-age-should-kids-learn-to-type) has the readiness test.

## How to test a child, if you are going to

- **Keep it short.** Thirty to sixty seconds. Longer becomes a test of attention.
- **Use age-appropriate words.** Unfamiliar vocabulary turns it into a reading assessment.
- **Test rarely.** Monthly is plenty. Weekly turns practice into performance.
- **Report accuracy first, or only.** Whatever you name is what they will chase.
- **Never compare siblings or classmates out loud.** It reliably produces a child who wants to stop.

More on testing conditions generally in [how to test your typing speed accurately](/blog/how-to-test-typing-speed).

> A useful reframe for a child who is fixated on the number: the score is not a grade, it is a thermometer. It tells you what to practise next. That framing is easier to sustain than "speed does not matter", which children correctly identify as untrue.
...
The dip is where children quit if nobody has told them it is coming.

## Common questions

### What is a good typing speed for a 10 year old?

School schemes commonly aim for somewhere around 15 to 20 words per minute by that age, but this is a target rather than a norm. Whether they are touch typing matters more: 15 with correct technique is a better position than 25 while looking down.

### Is my child behind if they are below these numbers?

Almost certainly not. These are curriculum targets for children receiving typing instruction, and most children are not. If your child has never been taught, comparing them to a taught benchmark is not meaningful.
...
Around 25 words per minute with correct touch technique puts a child in a comfortable position for the written work secondary school brings, and technique matters more than the figure because it is what keeps improving.
...
Watch them type for one minute without saying anything. Note two things: whether their eyes go down, and which fingers press C, B and the shift key.

Whatever you saw is the practice plan, and it is a much more useful answer than a number. There is a ten-minute daily structure in [typing practice for kids](/blog/typing-practice-for-kids-routine), and the wider picture for parents in [typing for kids](/blog/typing-for-kids-guide-for-parents).

KeyTopia's [children's world](/typing-for-kids) reports accuracy and technique rather than leading with a speed score, precisely because whatever gets measured is what a child will optimise for.
`,
...
**The fix:** type a home-row letter, then a reach, then a home-row letter, slowly, checking the return each time. Boring, and it works within days.

## 3. Typing C with the index finger

**The symptom:** the whole left hand shifts when you type common words like "because" or "practice".

C belongs to the **left middle finger**. Using the index pulls the hand off position and costs you the re-anchor. Because C is common, this leaks time constantly.

**The fix:** a word list heavy in C, typed at half speed while watching your hand.

## 4. B and Y taken by whichever hand is free
...
**The symptom:** capitals are noticeably slower than lowercase, and sentence openings feel clumsy.

Always use the **opposite** hand's shift: left-hand letter, right shift; right-hand letter, left shift. Pressing left shift and then a left-hand letter is a stretch with the hand locked, not a movement.

Since nearly every sentence starts with a capital, this cost is paid constantly, and it is one of the most common faults in self-taught typists.

**The fix:** drill sentence openings. Ten sentences, focusing only on which shift key you used.
...
**The symptom:** discomfort after twenty minutes; reaches to the top row feel like stretches.

A resting wrist anchors the hand, so reaching for a key above becomes a finger stretch against a fixed hand instead of a small extension with a slight hand movement. It slows the return stroke and is a common contributor to strain.

**The fix:** float the wrists while typing and rest between bursts, not during them. [Typing posture](/blog/typing-posture) covers the whole setup.

## 8. Practising above your controlled pace

**The symptom:** months of practice with no improvement in net speed, and accuracy that never gets past the low nineties.

Your nervous system strengthens whatever movement is repeated, and it has no access to your intentions. Typing at a pace where you make regular errors means rehearsing the errors alongside the successes.

**The fix:** practise at roughly 80% of your top speed, aiming for 96 to 98% accuracy. Speed sessions are useful in small doses as a diagnostic, not as a diet. The mechanism is in [why accuracy should come before speed](/blog/accuracy-before-speed).

## 9. Never practising punctuation, capitals or numbers
...
## 10. Practising everything instead of your own weak spots
...
**The fix:** measure per-key and per-transition timing, then drill the slowest. This is what [adaptive practice](/blog/adaptive-typing-lessons) does, and it is the difference between "practise more" and a list of six things.

## Diagnosing your own

The fastest self-check is to **type a paragraph at half speed and watch your hands**. At full speed you cannot see what is happening; at half speed the improvised movements are obvious.
...
Do not attack all ten at once; you will produce a fortnight of confusion and revert.
...
Expect each one to revert under pressure for a week or two after you fix it. That is what habit replacement looks like, not failure. [Breaking bad typing habits](/blog/break-bad-typing-habits) has the method for making one stick.

## Common questions

### How do I know which of these I have?

Type at half speed and watch your hands, then check the per-key data from a test. Most self-taught typists have between three and five of the ten, and the assignments for C, B, Y and shift are the most common by a distance.
...
Yes, briefly. Replacing an automatic movement means the new one is slower than the old one for a week or two. Fix one at a time so the dip is small and survivable.
...
Probably only the first two. Looking at the keyboard and failing to return to home are the ones that cost you attention rather than seconds, and attention is the thing you notice.
