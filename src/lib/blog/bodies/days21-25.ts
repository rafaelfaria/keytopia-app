/** Articles for days 21-25. */
export const DAYS_21_25: Record<string, string> = {
  'typing-posture': `
Good typing posture means feet flat, hips slightly above knees, elbows at roughly a right angle with forearms level, wrists straight and floating rather than resting, shoulders down, and the top of the screen at about eye level. Getting this right will not make you type faster. Getting it wrong will make you slower, and it does so gradually enough that most people blame something else.
...
**Whether you can keep doing it.** Discomfort that builds over months is the thing that ends people's typing, and it is entirely preventable.

Speed itself is barely affected in a one-minute test. This is why posture advice is easy to ignore and worth not ignoring.

## The setup, from the floor up

Work upwards. Each step depends on the one below it.

### Feet and chair

**Feet flat on the floor**, or on a footrest if they do not reach. Dangling feet shift your weight forward onto your thighs and you compensate with your back.

**Hips slightly higher than your knees.** Raise the chair until this is true. This tilts your pelvis very slightly forward and lets your lower back keep its natural curve without effort.

**Sit back in the chair**, using the backrest. Perching on the front edge means your back muscles are doing the work that the chair should be doing, and they tire.
...
**Shoulders down and relaxed.** Check this deliberately every so often; they creep up without you noticing, particularly under time pressure.
...
A wrist rest is for resting, and its name is accurate. Using it as a pivot is worse than not having one.

**Fingers curved**, as though holding a small ball, with fingertips on the keys rather than the pads. Flat fingers press with the pad, catch neighbouring keys, and reach badly.

**Keyboard flat, or tilted slightly away from you.** Almost all keyboards have little feet at the back that tilt them towards you, which bends your wrists upwards. Leave them folded down. A negative tilt is better than a positive one.

### Screen

**Top of the screen at roughly eye level**, about an arm's length away.

The typing-specific reason for this, beyond the neck: if the screen is low, you look down at it, and once your head is down your eyes will find the keyboard. Laptop users have this problem structurally, which is why a laptop stand and a separate keyboard is the single best equipment change most people can make.

## Sitting square to the keyboard
...
A laptop forces a compromise: if the screen is at the right height the keyboard is too high, and if the keyboard is at the right height the screen is too low. There is no posture that solves both.

If you use a laptop for more than about an hour a day:

- **Raise the laptop** on a stand so the screen top is at eye level, and use a **separate keyboard and mouse** at the correct height. This is the only real fix, and it is inexpensive.
- **Failing that**, prioritise the keyboard height for long typing sessions and accept the neck cost, or prioritise the screen for long reading sessions.
- **Never type at length with the laptop on your lap.** Both the wrist angle and the neck angle are wrong at once.
...
## Moving matters more than the perfect position

There is no posture you can hold for eight hours. The best position is a good default that you leave regularly.

- **Stand up every 30 to 45 minutes**, briefly. Frequency matters more than duration.
- **Change position within the good range** rather than holding one point.
- **Let your hands off the keyboard** between bursts of typing. Hovering over the keys keeps the forearms loaded continuously.

If you have persistent pain, numbness or tingling, that is a matter for a clinician rather than a typing article. Nothing here is medical advice, and posture adjustment is not a treatment for an existing injury.

## Posture for children

Children are usually sitting at furniture designed for adults, which is the whole problem.

- **Feet must reach something.** A box or a footrest is fine; dangling feet are not.
- **Raise the child, not the keyboard.** A cushion on the chair is easier than lowering a desk.
- **Screen at their eye level**, which is much lower than yours.
- **Watch for the keyboard being too far away**, which makes them lean forward and round their back.

A child who is uncomfortable will stop practising and neither of you will connect the two. It is worth five minutes to set up properly. More on the practicalities in [typing for kids](/blog/typing-for-kids-guide-for-parents).

## Common questions

### Does an ergonomic or split keyboard help?

It can, mainly by letting your forearms sit at a more natural angle instead of rotating inwards to meet a flat board. Whether it makes a noticeable difference is individual, and there is an adjustment period of a week or two during which you will be slower. It is not a speed upgrade. [Mechanical versus membrane keyboards](/blog/mechanical-vs-membrane-keyboards) covers what keyboard properties genuinely change typing.
...
It is better than sitting badly and not obviously better than sitting well. The advantage of a sit-stand desk is the change rather than the standing, and the same geometry rules apply either way: elbows at a right angle, wrists straight, screen at eye level.
...
See someone qualified. Then check the two most common contributors: wrists bent or resting while typing, and a desk that is too high. But pain is a signal to get it looked at, not to read more articles.
...
Teaching a child to type is mostly not a teaching problem. The technique takes an afternoon to explain; the difficulty is keeping ten minutes a day going past the second week, when the novelty has gone and their typing has got temporarily worse. Almost everything that works is about how you frame it rather than what you tell them.

## Start by deciding what you are actually asking for

Be clear with yourself, because it determines everything else: you are asking a child to become *worse* at something they can already do, for about three weeks, on the promise that it will be better later.

That is a genuinely hard sell to an eight year old. It is also the entire project. If you skip acknowledging it, you will interpret week two as resistance or laziness, when it is a perfectly rational response to being slower than they were on Monday.

Say it out loud, in advance: "This will feel slower for a few weeks. That is what is supposed to happen. Then it gets faster than before."

Children handle a difficulty they were warned about far better than one that appears unannounced.

## The five rules

Almost all of the outcome comes from these.

### 1. Ten minutes, not twenty

Short enough to be non-negotiable, and short enough to survive a busy week. Motor skills consolidate between sessions rather than during them, so five sessions of ten minutes beats two of twenty-five.

Ten minutes is also short enough that a child cannot build a case against it. "Practise your typing" with no end point invites negotiation every single day.

### 2. Same time, attached to something that already happens

After school, before dinner, right after they get their snack. A habit that has a fixed slot does not need a decision; one that has to be scheduled gets negotiated.

### 3. Hands covered from day one

A tea towel over their hands. This is the one thing that determines whether they end up touch typing or not.

The crucial detail: **it has to be how typing has always worked**, not a restriction introduced once they are comfortable looking down. A child who has typed while looking for two years will fight the cover exactly as an adult would. A child who has never done it any other way will not find it strange.
...
Those questions also do something else useful: they teach a child to notice their own weak spots, which is the skill that lets them eventually practise without you.

### 5. Stop while they still want to continue

Ending on a good run is worth more than three extra minutes. A session that ends in frustration is a session that makes tomorrow's harder.

## What to do in the ten minutes

A workable structure, roughly:
...
There is a fuller version in [typing practice for kids](/blog/typing-practice-for-kids-routine).

## Handling the specific difficulties

### "This is boring"

Usually true, and usually accurate about home-row drills specifically. Two responses that work better than insisting:

- **Shorten it.** Boring for ten minutes is tolerable. Boring for twenty is not.
- **Change the material, not the technique.** The same finger practice can happen on silly words, on the names of their friends, on a list of dinosaurs. The technique requirement stays; the content does not have to.

### "I'm slower than before"

They are. Agree with them, and reframe rather than deny: "Yes. You are learning the way that gets fast. The old way stops at about here." Children can accept a trade if it is named as a trade.

### They revert to two fingers when typing something real
...
**Do not make it a condition for screen time.** "Ten minutes of typing and then you can play" puts typing between them and what they want, and that association is difficult to undo. It also teaches them to get through it rather than to do it well.

**Do not use it as a punishment.** Same reason, more so.

**Do not sit and watch every session.** Being observed disrupts skilled movement in adults and children alike. Set them going, be nearby, look at the results afterwards.
...
Games work best as the last minute of a session rather than as the session. More on choosing them in [best typing games for kids](/blog/best-typing-games-for-kids), and on the wider question in [how to make typing practice fun](/blog/make-typing-practice-fun).

## A realistic timeline

| Week | What to expect |
|---|---|
| 1 | Slow, awkward, willing. The novelty carries it. |
| 2 | Slower than their old method. Resistance peaks here. |
| 3–4 | They stop looking at the keyboard, often without noticing. |
| 2–3 months | Comfortable, and faster than they were before. |
| 4–6 months | Capitals and punctuation become automatic. |

Week two is the one that decides the outcome. Everything in this article is really about getting through week two.

## Common questions

### How long should this take?

For a seven to nine year old at ten minutes most days: three to four weeks to stop looking at the keyboard, three to four months to be comfortable and faster than they were.
...
Yes, and the sooner the better. Two-finger typing tops out around 35 to 40 words per minute and requires looking down, which is the cost that actually matters. At eight or nine the habit is months old; at thirteen it is years old. [Helping kids stop typing with two fingers](/blog/kids-typing-with-two-fingers) has the plan.
...
## The three stages, and why the first one is the dangerous one
...
## The arithmetic, which is the other half of the argument

Even setting the motor learning aside, errors are expensive in a way people consistently underestimate.
...
Four to six keystrokes and a broken rhythm, for one wrong letter. The rhythm break is the expensive part: you were running an automatic sequence and have just interrupted it for a conscious decision.

This is why net speed can sit far below raw speed, and why a careful typist at 50 words per minute frequently produces finished text faster than a fast, sloppy one at 65.

## But not accuracy at any price

The advice is "accuracy before speed", not "accuracy above all". There is a band, and both sides of it cost you.

**Below about 95% accuracy**, correction overhead dominates. Every point of accuracy you buy here is worth more than the speed you give up for it.
...
## What "accuracy first" means in practice

It does not mean typing very slowly for months. It means:

**Practise at roughly 80% of your top pace.** You want the movement you will actually use, just under control. Practising at 40% trains a pace you will never type at, and the skill does not transfer upwards as well as people hope.

**Let speed be an output, not a target.** A movement repeated accurately gets faster on its own with repetition. You do not have to train speed directly nearly as much as most practice regimes assume.

**Use speed sessions as a diagnostic, not a diet.** Typing above your controlled pace for thirty seconds is genuinely useful: it shows you what breaks first, and what breaks first is your next practice target. Doing it every day rehearses the breakage.

**Drill the specific failures rather than being generally careful.** Once you are past the beginner stage, your errors are concentrated on a handful of keys and transitions. Applying caution to every keystroke to fix a few is expensive.

## Why the opposite advice is so common

"Just push your speed and accuracy will catch up" persists for two reasons, and both are worth naming because both contain a grain of truth.

**Speed practice does produce a short-term gain.** Push hard for a week and your peak score rises, because you are learning to tolerate a faster pace. Then it stops, because the errors you rehearsed have become part of the pattern.

**Accuracy practice feels like nothing is happening.** Typing at 80% pace with near-perfect accuracy produces no dramatic number. The improvement shows up two weeks later as a higher net speed, and by then most people have attributed it to something else.

This is a general problem with practice that works: the feedback is delayed, while the feedback from practice that does not work is immediate.

## The evidence, and its limits

Two things are well supported and worth separating from the folklore.
...
More on the underlying research in [the science of touch typing](/blog/science-of-touch-typing-muscle-memory).

## How to sequence a learning programme

If you are starting from scratch, or restarting properly:
...
### If I always type slowly, will I ever get fast?

Yes, provided "slowly" means about 80% of your top pace rather than half of it. A movement repeated accurately gets faster with repetition; you do not have to force it. What does not work is staying at a pace so slow it is a different movement.

### How long before accuracy work shows up as speed?

Typically about two weeks, and it shows up as a higher *net* speed rather than a higher peak. If you only look at your best raw score you may miss it entirely.
...
Especially. A fast typist with 90% accuracy has thoroughly practised a set of errors, and general practice is reinforcing them. The fix is targeted: identify the specific failing transitions and drill those. [How to improve typing accuracy](/blog/improve-typing-accuracy) covers the method.

### What accuracy should I be aiming for?

96 to 98% at your normal working pace. Below 95%, errors are your limit. Above 99% sustained, you are probably leaving speed on the table.
...
Fifteen minutes a day, split three ways, repeated for six weeks. The split matters more than the total: five minutes on your own weak keys, seven on real prose with full punctuation, three on one specific thing you are fixing. Undirected typing for fifteen minutes produces far less, because most of your remaining slowness is concentrated in a small number of specific places rather than spread evenly.

## Why fifteen minutes, and why daily

Motor skills consolidate **between** practice sessions rather than during them, including during sleep. Five sessions of fifteen minutes give you five consolidations; two sessions of thirty-five give you two, for the same total time.

This is one of the better-established findings in motor learning, and it has a very practical consequence: **if you only have ten minutes, do ten minutes.** Skipping because you do not have half an hour is the single most common way adult typing practice fails.

Fifteen minutes is also short enough to survive a working week, which is the only test that matters. A forty-minute plan is better in theory and gets abandoned in February.

## The session, split three ways

### Five minutes: your own weak keys

Not "practice", specifically **your** slow keys and transitions.
...
One at a time. This week it might be the opposite-hand shift; next week the little fingers; the week after, numbers.

Fixing one habit at a time works and fixing four at once does not, because each replacement needs enough repetitions to beat the existing habit under pressure. Spreading your attention across four means none of them gets there.

## A six-week progression

| Week | Weak keys (5 min) | Prose (7 min) | Focus (3 min) |
|---|---|---|---|
| 1 | Measure first; drill the two slowest keys | Simple prose, 80% pace | Return to home row after every reach |
| 2 | Same two keys, plus their transitions | Add commas and full stops | Opposite-hand shift on every capital |
| 3 | Re-measure; new slowest three | Full punctuation | Little fingers: A, Q, Z, P, semicolon |
| 4 | Slowest transitions, not keys | Longer passages, 3 min continuous | Apostrophes and quotation marks |
...
If you type for a living, you have a conflict: practice makes you temporarily slower, and you have things to send.

**For the first two weeks, keep them separate.** Practice sessions are strictly correct technique. Work is whatever gets the work done.

**From week three**, use the new technique for low-stakes typing: personal messages, notes, search boxes, chat where a typo costs nothing.
...
Two rules that keep the habit alive:

**Do five minutes instead of skipping.** The habit is worth more than the session. A five-minute day keeps the chain; a skipped day makes the next skip easier.

**Drop the hard part, keep the easy part.** If you have no capacity for weak-key drilling, type prose for five minutes at a comfortable pace. It is not optimal practice and it is much better than nothing.
...
If accuracy is your constraint, about two weeks. If you are correcting entrenched finger assignments, three to four weeks, with a dip first. If you already touch type well and are chasing the last twenty words per minute, months.

### Should I practise every day, including weekends?

Daily is better, but a plan that assumes seven days a week and collapses is worse than one that assumes five and holds. Five days a week is plenty.
...
Take one test at your ordinary pace. Write down three things: net speed, accuracy, and the two keys that came back slowest.
...
`,
  ...
  'is-40-wpm-good': `
Forty words per minute is a genuinely useful speed. It is comfortable for everyday computer use, adequate for most study and office work, and it is roughly where results on casual online typing tests tend to cluster. It becomes limiting in three specific situations: live note-taking, timed written exams, and any job where writing is most of the work. Whether 40 is "good" depends entirely on which of those applies to you.
...
## What 40 is comfortably enough for

- **Email and messaging.** You are not waiting for your hands in ordinary correspondence.
- **Web forms, searching, and general computer use.** Entirely fine.
- **Homework and coursework**, where you have time to spare.
- **Most office roles** where writing is part of the job rather than the job.
- **Writing your own prose**, where you are usually thinking more slowly than you type anyway.

That last point deserves emphasis, because it is the most common reason 40 turns out to be fine: when you are composing rather than copying, you spend a lot of time deciding what to say. Typing speed only binds when you already know the words.

## Where 40 starts to hurt

**Live note-taking.** This is the clearest case. Taking notes in a lecture or meeting means listening, deciding what matters, and typing simultaneously, with no ability to pause the input. At 40 you fall behind and then face a choice between listening and catching up. Around 50 to 60 it becomes viable.

**Timed written exams.** Where extended answers are produced on a keyboard, slow typing is a direct penalty on a task meant to assess your thinking. This is the strongest practical argument for improving.
...
The headline figure is the least informative number a typing test gives you. Check these instead.
...
This is the single most useful thing to know about your own 40. [How to stop looking at the keyboard](/blog/stop-looking-at-the-keyboard) is the fix.

### 3. Can you hold it for five minutes?

A 40 that is really a good fifteen seconds extrapolated is a different thing from a 40 you can sustain through a long email. Short tests flatter everyone. Take a two-minute test and see what happens.

## How 40 fits into the range

| Speed | Where it sits |
|---|---|
| Under 25 | Typing is a noticeable obstacle to most written tasks |
| 25–40 | Fine for everyday use; limiting for extended writing |
| **40–55** | **Comfortable for most work and study** |
| 55–70 | Typing has stopped being the bottleneck for nearly everything |
| 70–90 | Fast. The limit is now what you are thinking |
| 90+ | Specialist territory |

Notice how quickly the practical benefit flattens. The gap between 25 and 45 changes what you can do. The gap between 70 and 90 mostly changes how it feels.

## Getting from 40 to 60

If you have decided it is worth it, the route depends on which of the three checks above found something.

**If you are looking at the keyboard:** that is the whole project. Cover your hands, fifteen minutes a day, and expect two to three weeks of being slower before you are faster. This is the largest single gain available to anyone at 40.
...
## Is 40 good for a job application?

Where employers state a requirement, 40 to 60 words per minute is common for general administrative work, so 40 sits at the lower end of "acceptable" rather than comfortably inside it.

Two practical notes if you are being tested:

- **Employer tests usually use business prose with full punctuation**, not word lists, and they often run three to five minutes. Both push scores down relative to a casual online test. Practise accordingly.
- **Accuracy is usually part of the requirement**, sometimes explicitly. A 40 at 98% is a better result than a 45 at 90%.
...
Workable for homework and essays; limiting for live lecture notes and timed written exams. Around 50 to 60 covers everything comfortably. See [typing speed for students](/blog/typing-speed-for-students).
...
Getting from 40 to 80 is realistic but not quick: several months of consistent practice, and it requires touch typing. If you are currently at 40 while looking at the keys, the first three weeks will make you slower, and the remaining months will take you well past where you started.
