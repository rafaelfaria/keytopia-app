...
Not what it says it teaches. What it actually rewards, moment to moment.
...
### 1. Does it punish errors, or only reward speed?

The best mechanic for typing is one where an error ends the run or costs progress. That sounds harsh and is exactly right: it makes accuracy the winning strategy, which is what you want a child practising.

A game where you can hammer the keyboard and still advance is entertainment with a keyboard attached.

### 2. Can it be played without looking at the keyboard?
...
### 3. Are the words real, and age-appropriate?

Nonsense strings train raw key location, which has a place but is not where a child should spend most of their time. Real words build the whole-word patterns that make typing feel fluent.

They also need to be words the child can read at a glance. A seven year old typing unfamiliar vocabulary is being tested on reading, not typing, and the session teaches little about either.

### 4. Does it introduce keys in a sensible order?

Good typing material starts on the home row and adds letters by frequency and reach, not alphabetically and not all at once. A game that throws the whole keyboard at a beginner guarantees hunting.
...
Worth being clear, because it is where expectations usually go wrong.

**Games rarely teach finger assignment.** Almost none of them can tell which finger pressed a key, so a child can play a typing game for months with two fingers and improve at the game while getting worse at typing. This is the single biggest limitation, and it means games are a supplement to instruction, not a replacement for it.

**Games do not enforce not looking.** Only a cover over the hands does that.

**Games struggle to target weak keys**, because they are built around their own content rather than around your child's specific slow letters.

So the honest position is: games are excellent for volume and motivation, and poor for correctness. The correctness has to come from somewhere else.

## How to use games well

**Use them at the end of a session, not as the session.** Ten minutes of practice with a game as the last minute or two works. Ten minutes of game instead of practice mostly builds enthusiasm.

**Cover their hands during games too.** This is the one rule that makes games useful rather than counterproductive, and children accept it easily if it is simply how typing works.

**Pick difficulty deliberately.** If a child is making errors constantly, the level is too fast and they are practising mistakes. Drop it until they are succeeding most of the time.

**Watch which fingers move.** Five minutes of observation tells you whether the game is reinforcing technique or eroding it.

**Rotate.** Any single game becomes a game rather than practice once a child has learned its patterns.

## For different ages

**Ages 4–6.** Single-letter games only. No speed, no timers, no technique demands. The goal is that the keyboard is unremarkable.

**Ages 6–8.** Home-row word games, slow-moving falling words, anything with real short words. Introduce the hands-covered rule now.
...
A reasonable weekly shape for a child learning properly:

| Activity | Share | What it does |
|---|---|---|
| Structured lessons | About half | Finger assignment, new keys, correctness |
| Real-word practice | About a third | Transitions, punctuation, fluency |
| Games | The rest | Volume, motivation, sustained typing |

Games are the smallest slice and often the reason the other two happen at all. That is a perfectly good role.

More on the wider question of enjoyable practice, and the difference between fun that motivates and fun that distracts, in [how to make typing practice fun for kids](/blog/make-typing-practice-fun).

## Common questions

### Can my child learn to type from games alone?

They can get faster at hunting and pecking. They are unlikely to learn touch typing, because almost no game can tell which finger pressed a key and none of them will stop a child looking down. Pair games with structured practice.
...
Yes, for the same reasons and with the same limitations: good for volume and endurance, poor at correcting technique. An adult can at least self-monitor their fingers, which helps.

### How do I tell if a game is actually helping?

Watch, and test occasionally. If their accuracy is stable or improving and they are not looking down, it is helping. If their speed is rising while their accuracy falls, the game is rewarding the wrong thing and it is actively working against you.
...
Psychologists distinguish **explicit** knowledge, which you can report, from **implicit** or procedural knowledge, which shows up only in performance.
...
1. **Studying a keyboard diagram does very little.** It builds the kind of knowledge that does not drive typing.
2. **Knowing where a key is does not mean you can type it.** Almost everyone can point to R. Far fewer can reach it without looking.
3. **You cannot introspect your own weaknesses.** You do not know which keys are slowing you down. It has to be measured.

## The two loops

The most useful model of skilled typing comes from work by Logan, Crump and colleagues, and it describes a **hierarchy** rather than a single process.
...
- **Reading ahead speeds you up**, because it lets the outer loop stay ahead of the inner one rather than feeding it one word at a time.
- **Sub-vocalising the spelling slows you down**, because you are forcing the outer loop to do the inner loop's job letter by letter.
- **Thinking about your fingers makes you worse**, because attention pushes control back to a slower system.

That last one is a well-documented effect across skilled movements, and it is why typing under observation feels harder than typing alone.
...
**Associative stage.** You know what to do and are refining how. Errors become less frequent and less random. Movements become consistent. This is weeks two through eight, and it is where the repetitions do their work.

**Autonomous stage.** The skill runs itself, resists interference from other tasks, and becomes hard to describe. This is fluent touch typing, and it takes months rather than weeks.
...
This is the point where the mechanism becomes advice.

A movement guided by vision and a movement guided by the finger's own sense of position are **different skills**. When you watch your hand travel to a key, the visual system is doing the targeting. Nothing is being built that will let the finger get there in the dark.
...
## Why practice spacing matters

Two findings from motor learning research translate directly into a practice schedule.

**Distributed practice beats massed practice.** The same total time produces better retention when spread across more sessions. Fifteen minutes daily beats an hour and three quarters weekly.

**Consolidation continues after practice stops.** Motor skills keep stabilising in the hours after a session, including during sleep. This is why something awkward yesterday is sometimes easy today without any intervening practice.

Both point the same way: short, frequent sessions with rest between them, and no benefit to grinding on once a session has stopped going well.

## What this means for a practice session

Putting the above together:

- **Do not study the layout.** Type instead.
- **Cover your hands from session one**, because vision-guided practice builds the wrong skill.
- **Practise at an accuracy you can hold**, so the repetitions count towards the movement you want.
- **Practise often and briefly.**
...
### Is it really true that typists cannot draw a keyboard?

They do it much worse than their typing implies. Research asking skilled typists to place letters on a blank keyboard diagram has consistently found substantial gaps, despite the same people typing those letters accurately. The explicit knowledge and the knowledge driving the fingers are largely separate.

### Does that mean learning the layout is pointless?

Studying a diagram is nearly useless as a way of learning to type. Knowing roughly where things are is fine and happens anyway; the skill is built by typing, not by looking at a picture.

### Why do I type worse when I concentrate on it?

Because attending to an automatic skill disrupts it, pushing control back to a slower, more deliberate system. This is well documented across skilled movements. It is also why you can type a word fluently and then fail to type it when someone asks you to demonstrate.
...
## The jamming story, and what is wrong with it

The version everyone has heard: on early typewriters, typebars struck a common point, and two bars swinging at once would clash and jam. Sholes therefore scattered common letter pairs to slow typists down and prevent this.
...
There is also a persistent anecdote that the top row was arranged so a salesman could type "TYPEWRITER" using one row. It is true that you can. Whether that was ever a design goal is not documented, and it has the shape of a story invented afterwards to explain a coincidence.

## Why it survived

This is the more interesting question, and the answer is largely commercial.
...
It is not optimised for typing efficiency by any modern measure. Common letters are spread across rows, the left hand does more work than the right for most English text, and some frequent sequences require awkward same-finger movements.

Whether that costs you meaningful speed is a different question, and the evidence is weaker than the enthusiasm.

**Dvorak.** August Dvorak and William Dealey patented the Dvorak Simplified Keyboard in 1936, placing vowels under the left hand and common consonants under the right so that more typing happens on the home row. Early studies reporting large advantages were largely conducted by Dvorak himself. A 1956 study for the US General Services Administration, led by Earle Strong, found no significant advantage for retrained typists. Economists Stan Liebowitz and Stephen Margolis reviewed the evidence in 1990 and argued the case for Dvorak's superiority had been substantially overstated.

**Colemak**, created by Shai Coleman and released in 2006, is a more conservative redesign: it moves common letters to the home row while keeping most of QWERTY's punctuation and bottom row, which makes it easier to learn from QWERTY and preserves familiar shortcuts.

Modern alternative layouts do measurably reduce finger travel. Whether reduced finger travel produces meaningfully faster typing for a given person is much less clear, because finger travel is not obviously the binding constraint at normal speeds.

## Should you switch?

For most people, no. The honest case:

**Arguments for:** less finger movement, more home-row typing, and many users report greater comfort. If you type for many hours a day and find QWERTY uncomfortable, it is a reasonable thing to try.

**Arguments against:**

- **You will be slow for weeks to months.** You are learning a new motor skill from scratch, and the old one interferes.
- **Every other computer is QWERTY.** Colleagues' machines, public terminals, borrowed laptops, phones.
...
QWERTY is not universal even among Latin-script keyboards.

| Layout | Where | What differs |
|---|---|---|
| QWERTY | UK, US, most of the world | The baseline |
| QWERTZ | Germany, Austria, Switzerland, Central Europe | Y and Z swapped; umlauts on the home row |
...
Christopher Latham Sholes, working with Carlos Glidden and Samuel Soulé, with the layout evolving through the early 1870s and being finalised in collaboration with E. Remington and Sons around 1874.
...
Familiarity, entirely. There is no mechanical reason on a touchscreen, and several alternatives have been tried. People already know QWERTY, which on a phone is the whole argument.

### Will QWERTY ever be replaced?

Ninety years of documented alternatives have not displaced it. The switching cost is paid by individuals and the benefit is uncertain, which is a poor recipe for change.

## The practical takeaway

The layout under your hands is a historical accident that has been stable for a century and a half, and it is almost certainly not what is limiting your typing.
...
You cannot delete a habit. You can only build a competing one and then win the situations where the old one used to fire. That is why typing habits you have had for years come back the moment you are under pressure, and why the fix is a specific four-week process rather than a decision to do better. Fix one habit at a time, expect reversion, and plan for the situations where it happens.

## Why the old habit keeps winning
...
**It is invisible from the inside.** You cannot feel yourself using the wrong finger, because it is exactly as automatic as the right one would be. This is why people are surprised when they finally watch their own hands.

## Find out what you actually do

Two methods, and you want both because they catch different things.

**Type at half speed and watch your hands.** At full speed you cannot see what is happening. At half speed the improvised movements are obvious. Use a sentence chosen to expose the usual suspects:
...
Do not fix these simultaneously. In order of value:

1. **Looking at the keyboard.** The ceiling above which nothing else matters. Fix this alone, first.
...
Order matters. Fixing the assignment for C is worth more than fixing the one for Z, because C is common. Work down the frequency of the letters involved.

Full detail on each in [10 typing mistakes that are slowing you down](/blog/typing-mistakes) and [correct finger placement](/blog/correct-finger-placement-for-touch-typing).

## The four-week replacement cycle

One habit. Four weeks. Then the next one.

### Week 1: isolate it

Practise the new movement on its own, away from real typing, slowly enough that the correct version always wins.
...
Now type real sentences containing the target letter, still deliberately slowly. The old habit will start reappearing, which is the point: you need repetitions where the new movement wins *against* the competing one, not just repetitions in a vacuum.

Expect it to fail regularly this week. Do not restart the sentence when it does; reset your hand and carry on.
...
Use it for everything, accept a slightly slower week, and pay particular attention to the trigger situations you identified in week three.

By the end of week four the new movement is usually winning most of the time. It will still revert occasionally under real pressure for a month or two afterwards, and that is normal rather than a sign it has not worked.

## The three things that make this fail

**Fixing several habits at once.** Each replacement needs enough repetitions to beat an entrenched pattern. Splitting your attention across four means none of them gets there, and you get a fortnight of confusion followed by a full reversion.

**Trying to fix habits during real work in week one.** You will hit something urgent, revert, and conclude the project failed. Ring-fence a practice session and leave your working typing alone until week three.

**Treating reversion as failure.** It is not a moral event. The old pattern has more repetitions; it will keep firing until the new one has enough. People who expect this get through it and people who do not, quit.
...
Do this one first and alone. Everything else is downstream.
...
| Week | What you are doing | Expect |
|---|---|---|
...
No. Duration makes the old habit stronger but does not make the new one unlearnable. Adults replace motor habits successfully; it takes longer than it does for a child and it works. [Can you learn touch typing later in life](/blog/learn-touch-typing-later-in-life) covers what genuinely changes.
...
Sixty is interesting because of what it implies rather than what it measures.

Almost nobody reaches 60 words per minute while looking at the keyboard. Visually guided typing tops out around 35 to 40 for most people, because the eyes have to guide each landing. So if you are at 60, you are very probably touch typing at least most of the time, with most keys automatic.

That means you have already done the hard part. The remaining work is different in kind: not learning where the keys are, but removing a small number of specific stalls.

## What 60 is enough for
...
- **Programming**, where prose speed was never the limit anyway.

Where 60 is not enough: professional transcription, some data entry roles, and competitive typing. Those are the exceptions rather than the rule.

## Where 60 sits

| Speed | What it usually means |
|---|---|
| Under 40 | Often still looking at the keys, at least sometimes |
| 40–55 | Touch typing, still consolidating |
| **55–70** | **Fluent. Typing is no longer the bottleneck** |
| 70–90 | Fast. Thinking is now the constraint |
| 90+ | Deliberately trained |
...
If you are stuck here, it is almost certainly one of these, and they need different work from what got you to 60.
...
This is the single most common cause of a plateau at 60, and it is why general practice stops working: you are spreading effort evenly across a problem that is concentrated.

### 2. Punctuation, capitals and numbers
...
### 3. Rhythm rather than peak speed
...
## Getting from 60 to 75

A realistic plan, and it looks different from the plan that got you to 60.

**Stop doing general practice.** Typing more paragraphs is what got you here and it will not take you further.

**Measure per-transition timing** and drill your slowest ten letter pairs. Type each as a short repeated string at a pace where it is correct, then embed it in real words.

**Practise on real prose with full punctuation**, not word lists. This alone often closes most of the gap between a test score and working speed.

**Fix same-hand shift** if you have it. Drill sentence openings, paying attention only to which shift key you used.

**Train evenness, not peak.** Type to a steady beat, slower than your top speed. Removing the stalls raises the average more reliably than raising the ceiling does.
...
An honest question, and worth answering deliberately rather than assuming faster is better.

**Reasons to stop at 60:** typing is no longer your bottleneck for any ordinary task. Time spent getting to 75 has almost no practical return for most jobs. [How much time faster typing saves](/blog/time-saved-by-typing-faster) does the arithmetic and the answer at this level is small.

**Reasons to continue:** long writing sessions are less tiring when typing takes less effort; the improvement is pleasant; and if you write for a living, marginal gains compound over years.

Both are reasonable. What is not reasonable is spending six months on it under the impression that it will transform your productivity.

## Common questions

### Is 60 wpm fast?

It is comfortably above where casual typing test results cluster and it is fluent by any practical standard. "Fast" in competitive terms starts considerably higher, but competitive typing is a hobby rather than a benchmark for anything.
...
More than enough. Around 50 to 60 covers live lecture notes, which is the most demanding student typing task. See [typing speed for students](/blog/typing-speed-for-students).

### Why am I stuck at 60?

Almost always one of the three limits above: specific slow transitions, punctuation and capitals, or uneven rhythm. General practice will not move any of them, which is why it feels like effort with no result.

### How long to get from 60 to 100?

Months of deliberate, targeted practice, and it is a genuine project rather than a by-product of typing a lot. [How to reach 100 WPM](/blog/how-to-reach-100-wpm) sets out what changes at that level.
