/** Articles for days 31-35. */
export const DAYS_31_35: Record<string, string> = {
  'typing-practice-for-kids-routine': `
Ten minutes a day, at the same time, in four short parts, with their hands covered. That is the whole routine, and its most important property is that it is small enough to survive a school term. A twenty-minute plan is better in theory and gets abandoned in the third week, which makes it worse in practice.

## Why ten minutes

Two reasons, and both are about how the skill is actually built.

**Motor skills consolidate between sessions, not during them.** Five sessions of ten minutes give you five consolidations; two sessions of twenty-five give you two, for the same total time. Frequency beats duration for this kind of learning, and it is one of the better-established findings in motor learning research.
...
This part does two jobs. It builds the transitions between letters, which is where most typing time actually goes and which drills do not train. And it makes the session feel like typing rather than exercises, which matters for whether it continues.
...
**Hands covered, always.** A tea towel over their hands. This is the single decision that determines whether they end up touch typing or not, and it only works if it is how typing has always been rather than a restriction introduced later.
...
**Do not sit and watch every session.** Being observed disrupts skilled movement in children as much as in adults. Set them going, be nearby, look at the result afterwards.

## What the week looks like

A workable four-week shape for a child starting from scratch:
...
The four-part structure stays; the contents change.

**Once they have all the letters:** Part 2 becomes punctuation, then numbers. Part 3 becomes longer sentences.

**Once they are not looking at all:** Part 2 becomes their specific weak keys. This is the point at which general practice stops being the most useful thing, and knowing *which* keys requires measurement rather than guessing.

**Once they can type for three minutes continuously:** add endurance. Part 3 becomes one continuous passage rather than separate words.

**Once it is automatic:** stop the routine. Typing is one of the few skills where a finite project genuinely finishes. Maintain it by using it.

## On days when it does not happen

**Five minutes instead of skipping.** The habit is worth more than any individual session, and a skipped day makes the next skip easier.
...
Let them, on the day. Do not increase the daily requirement, because the requirement has to be something that survives a week when they do not want to.

### How long before I see progress?

Three to four weeks before they stop looking at the keyboard, three to four months before they are comfortable and faster than they were with two fingers. There will be a visible dip in week two.

### Should weekends count?

Daily is better, but a plan that assumes seven days and collapses is worse than one that assumes five and holds. Five days a week is fine.
...
Expected, and worth leaving alone for the first month. Correcting them during homework turns their homework into a typing lesson and makes them resent both. Keep the correction inside the ten minutes; it migrates across on its own. [Helping kids stop typing with two fingers](/blog/kids-typing-with-two-fingers) has the fuller plan.
...
## Why you cannot just work out your own weak keys
...
The practical consequence: identifying your weak spots requires measurement, not introspection.

## What gets measured

Four things, and the second one is where most of the value is.
...
**Consistency.** The variation in your inter-key intervals. A typist whose timing is uneven has a different problem from one who is uniformly at their limit, and needs different practice.

## How a practice set gets built from that
...
That last step is what makes it adaptive rather than merely personalised. A fixed list of your weak keys from six weeks ago is a list of the keys that used to be weak.

## What good adaptive practice looks like from the outside

Some things worth checking, because "adaptive" is a word that gets applied loosely.
...
Adaptive practice is not magic, and there are three ways it goes wrong.

**Overfitting to a bad day.** One tired session can make a perfectly good key look weak. Good systems require repeated evidence before targeting something.

**Drilling the rare.** Optimising your Z transitions is technically an improvement and practically worthless. Frequency weighting exists to prevent this.

**Narrowing too far.** If practice consists only of your weakest five transitions, you stop practising everything else, including the endurance and rhythm that only come from typing continuous text. Targeted work should be part of a session, not the whole of it.

**Confusing difficulty with adaptation.** Speeding up a falling-words game as you improve is difficulty scaling. It responds to your overall level, not to your specific weaknesses, and it will not tell you that your same-finger transitions are what is capping you.
...
The proportions matter. All-targeted practice produces someone who is good at their weak keys and has not typed a paragraph in a month. There is a full progression in [typing practice for adults](/blog/typing-practice-for-adults).
...
### Is adaptive practice better than a fixed curriculum?

They do different jobs. A fixed curriculum is the right thing for a beginner, because you need the letters introduced in a sensible order and you have no data yet. Adaptive practice takes over once you have all the keys and your weaknesses have become specific.
...
Past the beginner stage, usually yes, because the same practice time goes to the places that are actually costing you. In the first month the difference is small, because at that stage everything is a weakness.
...
KeyTopia's [adaptive practice](/adaptive-practice) updates a per-key picture on every keystroke and builds each session from whatever came back slowest, weighted by how often those letters actually appear. The [typing test](/typing-test) will show you the same data in one sitting if you want to see the shape of it first.
`,
...
Only the fourth is about age, and it is the smallest of the four.

## What actually changes physically

Being straight about this is more useful than reassurance.

**Fine motor speed declines gradually with age.** Simple reaction times get slower, and rapid repeated finger movements become somewhat slower. This is well documented and it is real.

**But skilled typists compensate.** There is a genuinely interesting finding in the typing research literature: older skilled typists can maintain typing speeds comparable to younger ones despite slower simple reaction times, apparently by looking further ahead in the text. They buy time by reading further in advance, which lets them prepare movements earlier.
...
**Your ability to learn a new motor pattern.** Adults learn instruments, languages and sports throughout life. Typing is a considerably smaller skill than any of those.
...
Five modifications worth making.

### 1. Take the reach pressure off

If the top-row and outer-column stretches are uncomfortable, that is worth addressing rather than enduring.

- **Check the keyboard size.** A compact keyboard with slightly reduced key spacing genuinely reduces the required span.
- **Keep the keyboard flat**, not tilted towards you. Almost every keyboard has feet at the back that bend your wrists upwards; leave them folded.
- **Consider a split or tented keyboard** if your forearms feel rotated. Not a speed upgrade, but a comfort one, and comfort is what determines whether you keep practising.

### 2. Sort the screen out first

Get the top of the screen to roughly eye level, and make sure your glasses are right for that distance. This is the most commonly overlooked fix and one of the most effective, because a screen you cannot comfortably read is a screen you look away from.

### 3. Shorter sessions, more of them

Ten minutes twice a day rather than twenty once. Easier on the hands, and it gives you more consolidation opportunities, which is where the learning settles.

### 4. Train reading ahead, deliberately

Practise keeping your eyes one to two words ahead of your fingers. This is the compensation strategy that skilled older typists appear to use naturally, and there is no reason to wait for it to develop by accident.

Start by reading a whole phrase before typing it, rather than reading and typing word by word.

### 5. Expect the dip and name it in advance

Two to three weeks of being slower than your current method. Knowing this is coming is most of what gets people through it. The specific failure mode for adults is quitting in week two, when the new method is clearly worse and nothing visible is improving yet.
...
|---|---|---|
| 1–2 | Home row, hands covered, ten minutes twice daily. No measurement. | Slower than your current method. Frustrating. |
| 3–4 | Add letters in small groups. Start reading one word ahead. | Still slower, but you stop looking down. |
...
### Is there an age at which it becomes too late?

No known one. The relevant question is whether you have the fifteen minutes a day and the tolerance for a few awkward weeks, not what year you were born.

### Will I be as fast as a younger person?

Possibly not at the top end, since fine motor speed does decline. But typing speed varies enormously between individuals of any age, and the difference attributable to practice dwarfs the difference attributable to age at any level short of competitive typing. Comfortable fluency is entirely achievable.
...
Not necessarily, and it depends entirely on your situation, which is a question for a clinician rather than an article. What is worth knowing is that touch typing can be *less* demanding than hunt-and-peck, because it involves smaller movements from a fixed hand position rather than the hand travelling constantly. Adapted approaches with fewer fingers work on the same principles: fixed assignments, a consistent anchor, and not looking.

### How much should I practise?

Ten minutes, twice a day, rather than twenty once. Easier on the hands and better for consolidation.
...
Not laziness, and not a failure of instruction. Put a keyboard in front of anyone who has never been taught and they will use two index fingers, because:

- **It requires no learning.** Find the letter, press it. The alternative requires memorising which finger does what.
...
Worth being precise, because "it's slower" undersells it.

**A ceiling around 35 to 40 words per minute.** Two-finger typing tops out there for almost everyone, because the hands travel further and the eyes have to guide each landing.
...
Nine to twelve still works well and takes two to three weeks longer.

## The plan

Five stages. Do not skip stage one.

### Stage 1: Do not tell them off for it (day 0)
...
### Stage 2: Change the situation, not the instruction (week 1)
...
### Stage 3: Give the new method somewhere it wins (weeks 1–2)

Start with home-row-only exercises, where the correct fingers are obviously easier and the reaches are short. A child typing "salad" and "flask" with their hands covered will find proper technique straightforwardly better, and that experience does more than any explanation.

Ten minutes a day, four parts: warm up, new letters, real words, something fun. There is a full structure in [typing practice for kids](/blog/typing-practice-for-kids-routine).

### Stage 4: Ride out the dip (weeks 2–3)
...
### Stage 5: Let real typing be real typing (weeks 1–4)
...
| Week | Where they are |
|---|---|
| 1 | Slow and willing. Novelty helps. |
| 2 | Slower than their old method. Resistance peaks. This week decides it. |
| 3 | Stop looking at the keyboard, often without noticing they have. |
| 4 | Back around their old speed, and it starts appearing in real typing. |
| 2–3 months | Comfortably past where they were, and still improving. |

## What to watch for

Once they are using more fingers, check the assignments that children most often improvise:
...
### My child types faster with two fingers. Why change?

Because it is a ceiling, not a stage. Two-finger typing stops improving; touch typing keeps improving for years. The three weeks where they are slower buys them the rest of their typing life, and at eight or nine that trade is cheap.
...
Three to four weeks for the habit to flip in practice sessions, and a couple of months before it is their default everywhere. Add two to three weeks if they are eleven or older.

### Should I stop them typing at all until they learn properly?

No. That makes typing into a restricted activity and buys very little. Let real typing happen however it happens for the first month, and keep the technique work in the ten minutes.

### They say the towel is annoying.

It is. It is also the thing that works, and children accept it much more easily when it is presented as how typing is done rather than as a rule imposed on them specifically. If it is genuinely a battle, a cardboard shelf resting on the desk edge is less irritating than fabric on the hands.

### What if they are already twelve or thirteen?

Still very much worth doing, and it is now closer to the adult process: ring-fence practice from real work, expect a longer dip, and fix one assignment at a time. [Learning touch typing as an adult](/blog/learn-touch-typing-as-an-adult) applies more than the children's advice does.
...
KeyTopia's [children's world](/typing-for-kids) keeps the words age-appropriate and reports accuracy rather than leading with a speed score, which matters here: a child chasing a speed number during the transition will simply go back to two fingers, because on any given day that is still the faster option.
`,

  'best-way-to-practise-typing': `
Random letters, common words and full sentences each train something different. Random letters train raw key location. Words train the transitions between letters and the whole-word patterns that make typing feel fluent. Sentences train punctuation, capitals, rhythm and endurance. Most people practise almost exclusively on one of the three, which is why practice can feel productive and change nothing.

## What each material actually trains

### Random letters and nonsense strings

**Trains:** finding individual keys, and the specific transitions the generator produces.

**Good for:** beginners learning where keys are; targeted drilling of a specific weak transition; anyone whose problem is a particular reach rather than fluency.

**Bad for:** almost everything else. Random strings force letter-by-letter processing by design, which is precisely the mode fluent typing is trying to leave behind. They also produce letter pairs in proportions that have nothing to do with English, so most of the practice goes to sequences you will rarely type.

**The exception that makes them valuable:** a generated string that is deliberately dense in *your* weak transitions is one of the most efficient drills there is. The problem with random letters is the randomness, not the nonsense.
...
**Bad for:** punctuation and capitals, which most word lists contain none of. This is why so many people's test scores look fine while their real writing feels slow.

### Full sentences and real prose

**Trains:** everything the other two do, plus punctuation, capitals, rhythm, reading ahead and endurance.

**Good for:** the majority of intermediate and advanced practice, and for closing the gap between a test score and real working speed.

**Bad for:** targeting a specific weakness. A paragraph containing your worst transition twice is not a drill.

## The split that works

For most people past the first fortnight:

| Material | Share of the session | Why |
|---|---|---|
| Targeted drills on your weak transitions | About a third | Where the remaining time actually goes |
| Real prose with full punctuation | About half | Fluency, rhythm, punctuation, endurance |
| Common-word runs | The rest | Whole-word patterns, speed bursts |
| Pure random letters | Rarely | Only when learning a key from scratch |

The proportions shift with level. A complete beginner does much more of the first two rows in their simplest forms. Someone at 70 words per minute does almost none of the fourth and much more of the first.
...
The fix is simple and most people never make it: **practise on real prose with full punctuation**. This alone often closes most of the gap between someone's test score and their working speed.

## Why the material must match the goal
...
The distinction: repeat **sequences**, not passages. A short awkward string, drilled deliberately, is a drill. A paragraph typed twenty times is a memory test with a typing score attached.

## Reading ahead, and the material that teaches it

One of the largest differences between a fluent typist and a merely competent one is that the fluent typist's eyes are a word or two ahead of their fingers.

This is trainable, and only some material trains it:

- **Random letters make it impossible.** There is nothing to read ahead into.
...
Fifteen minutes, for an intermediate typist:
...
**Words must be readable at a glance.** A child typing unfamiliar vocabulary is being tested on reading, and the session teaches little about either skill.

**Nonsense strings are worse than useless for children**, beyond the first few days of learning a key. They are demotivating and they train the least valuable thing. Real short words work better at every stage.

More in [typing practice for kids](/blog/typing-practice-for-kids-routine).

## Common questions

### Is it better to practise words or sentences?

Sentences, for most of your practice, once you have the letters. They train punctuation, rhythm and reading ahead, which words do not. Keep word runs for speed bursts and whole-word pattern work.

### Are random letters ever worth it?

For learning a key from scratch, and for drilling a specific weak transition when the string is *chosen* rather than random. Genuinely random practice is close to the least efficient material available.

### Should I practise typing things I actually write?

It is a good final stage. Typing your own emails and documents deliberately, with attention to technique, transfers directly. It is a poor early stage, because you cannot separate typing difficulty from composition difficulty.

### Does typing in a different language help?

It changes which transitions you practise, which can be useful if you type that language. It does not otherwise improve English typing and may cost you, since the letter frequencies differ.

### How fast should I type while practising?

About 80% of your top speed, aiming for 96 to 98% accuracy. Slower than that trains a pace you will not use; faster rehearses errors. The reasoning is in [why accuracy should come before speed](/blog/accuracy-before-speed).
