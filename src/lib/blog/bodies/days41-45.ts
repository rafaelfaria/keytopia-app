...
Three numbers you can get in ten minutes.
...
Realistic, not aspirational. From 40 to 60 is a normal outcome of six weeks of daily practice. From 70 to 100 is a six-month project with an uncertain endpoint.

Then:

> **Minutes saved per day = (words ÷ old speed) − (words ÷ new speed)**

## A worked example

Take someone typing 2,000 words a day, going from 40 to 60 words per minute.

- At 40 wpm: 2,000 ÷ 40 = **50 minutes** of typing
...
- 2,000 words at 70 wpm: **29 minutes**
- 2,000 words at 90 wpm: **22 minutes**
- **Saved: about 7 minutes a day**

Against a training cost of several months. The return has collapsed, and this is the general pattern: **the gain from any improvement shrinks as your starting speed rises**, because you are dividing by a bigger number.

| From → to | Minutes saved per day at 2,000 words |
|---|---|
| 25 → 40 | 30 |
| 40 → 60 | 17 |
| 60 → 80 | 8 |
...
The first row is transformative. The last is a rounding error.

## Why the real answer is smaller than that

Three reasons the arithmetic overstates the benefit.

**You are not typing continuously.** The calculation assumes your fingers move without pause. In reality you stop to think, to read, to decide what to say. For composed writing, typing is often a minority of the elapsed time.

**Thinking is usually the constraint.** Above about 70 words per minute, most people are waiting for their next sentence, not for their hands. Doubling your speed does not halve the time spent on something you are still working out.
...
And now the other direction, which is the part the sceptical answer misses.

**Attention, not minutes.** Working memory is limited. If typing requires attention, it competes with composing, and a hunt-and-peck typist writing an essay is repeatedly leaving the sentence to find a letter. The cost is the lost thread, not the second.
...
- You type below about 40 words per minute, or you look at the keyboard. This is the largest single gain available to anyone, and the training is six weeks.
- Your accuracy is below 95%. Errors cost four to six keystrokes each, and fixing accuracy is faster and cheaper than fixing speed.
- Your job is substantially transcription, data entry or high-volume correspondence.
...
## The things that save more time than typing speed

Worth saying plainly, because they are usually cheaper.

**Keyboard shortcuts and editor navigation.** Word-delete, jump-by-word, select-line, switch-window, search. For most people these are worth more than ten extra words per minute and take an afternoon to learn.

**Text expansion and templates.** If you type the same paragraph weekly, typing it faster is the wrong optimisation.

**Not looking at the keyboard.** Even at the same speed, this changes what typing costs you in attention.

**Writing shorter emails.** Uncomfortable, and true.
...
Not looking at the keyboard, by a wide margin. It removes the ceiling that visually guided typing imposes and it changes what typing costs in attention. [How to stop looking at the keyboard](/blog/stop-looking-at-the-keyboard) is the method.
...
Only if they are slow, and only voluntarily. The arithmetic supports it for people below 40 words per minute and not for people above 60, so a blanket programme spends most of its budget where the return is smallest.
...
Before choosing anything, ask: **if you removed the typing, would the activity still be fun?**
...
## What actually motivates children at a keyboard

Four things, in rough order of how long they last.

### Visible progress on something they care about

Not a score, and not praise. A record of their own improvement over weeks.

Children are quite good at knowing when praise is untethered from anything. "Well done, that was great" produces nothing; "you got the whole home row without looking, you couldn't do that last week" produces something, because it is checkable and it is theirs.

A simple chart of their own accuracy over time is more motivating than most game mechanics, and it lasts longer.

### Competence, arriving faster than expected

The strongest motivator available and the one most often squandered by starting too hard.

If a child is failing most of the time, the activity is not fun regardless of the theme. Drop the difficulty until they are succeeding most of the time, then let it rise. A child who feels competent will practise; one who feels bad at something will avoid it, and no amount of decoration changes that.

### Real content they chose

The same finger practice can happen on nonsense syllables, or on the names of their friends, their favourite dinosaurs, football teams, or the silliest sentence they can invent.

The technique requirement does not change. The content is free, and letting them choose it costs nothing and buys a surprising amount.
...
**Type what they say.** They dictate a story, sentence by sentence, and type it. Their own words, so the reading is free and the motivation is built in.

**Silly sentence of the day.** They invent it, you both type it. Ten seconds of setup, and it turns a drill into a joke.

**Beat yesterday, not a number.** Compare only against their own last session. Comparing to a target, a sibling or a classmate reliably produces a child who wants to stop.

**The blind challenge.** Cover their hands and see how far they get. Framed as a challenge rather than a rule, this is the single most useful thing they can do and children often enjoy it.

**A words-they-know list.** Family names, pets, places they have been. Fluent reading means the session is about typing rather than decoding.

**Two minutes of anything at the end.** A game, a free choice, typing rubbish as fast as possible. Ending on the enjoyable part matters because it is the last thing they remember about typing today.

## The trap: rewarding speed
...
**What to do instead:** make accuracy the win condition. A game where one mistake ends the run trains exactly the right behaviour, and children find it every bit as compelling.

## The other trap: typing as the price of screen time

"Ten minutes of typing and then you can play."

This looks like sensible parenting and it does something specific and unhelpful: it places typing between the child and what they want, which is the definition of an obstacle. It teaches them to get through it rather than to do it well, and the association is difficult to undo later.

The same applies to typing as a punishment, more so.
...
More detail, including what each game mechanic actually trains, in [best typing games for kids](/blog/best-typing-games-for-kids).

## How much of the session should be fun

A workable split for a ten-minute session:

| Part | Time | Character |
|---|---|---|
| Warm-up on something they can do | 2 min | Easy, confidence-setting |
| The new thing | 4 min | Genuinely work |
...
## Getting through week two

Everything above matters most in the second week, which is when their typing is worse than the two-finger method they arrived with and the novelty has gone.

Three things help:

**Say it in advance.** "It gets slower for a couple of weeks, then faster than before." Predicted difficulty is tolerable; unexpected difficulty feels like failure.
...
No. Almost no game can tell which finger pressed a key, so a child can improve at the game while getting worse at typing. Games supply volume and motivation; correctness has to come from structured practice with their hands covered.

### How do I keep it going for three months?

Keep it small and attached to something that already happens. Ten minutes after school, every day, is easier to sustain than any amount of enthusiasm. The habit does the work, not the motivation.
...
Five minutes of practice then five of game is a reasonable trade and much better than a fight. What does not work is framing the game as a reward for the lesson, which tells them the lesson is the price.

## This week

Ask them for the silliest sentence they can think of. Cover their hands. Type it together, badly, and laugh about it.
...
The biggest single source of disagreement, and it has three common variants.

**Penalty method.** Count everything typed, then subtract a word for each uncorrected error. Roughly: *(characters ÷ 5 − errors) ÷ minutes*.

**Correct-characters method.** Count only the characters that are correct in the final text, divide by five. Common in modern browser tests.

**Blocking.** You cannot proceed until the error is fixed. This converts mistakes into lost *time* rather than into a lower accuracy figure.

These produce genuinely different numbers from identical typing. A blocking test punishes a careless typist through the clock; a penalty test punishes them through the score; a correct-characters test may barely punish them at all if they corrected everything.

If your score is much higher on one site than another, this is usually why.
...
**Practical consequence:** if you want a number that predicts your working speed, test on prose with full punctuation, not on word lists.

## 3. Test duration

Short tests produce higher and more variable scores, for a straightforward reason: they extrapolate a burst.

A fifteen-second test multiplies your best fifteen seconds by four. You can hold well above your sustainable pace for that long. You cannot for two minutes.

| Duration | What it measures |
|---|---|
| 15 seconds | Peak burst speed |
| 30 seconds | Burst, slightly tempered |
| 60 seconds | A reasonable working figure |
| 2 minutes | Sustainable speed |
| 5 minutes | Speed plus endurance |

Most people's five-minute figure is meaningfully below their fifteen-second one, and the gap is itself diagnostic: a large drop usually means tension, posture or fatigue rather than technique. [Typing posture](/blog/typing-posture) is where to look.

## 4. When the timer starts, and what counts

Small decisions with a real effect on short tests.

**Timer on page load versus on first keystroke.** If the clock starts when the page appears, the second or two you spend orienting comes out of your score. On a fifteen-second test that is a large proportion.
...
## 5. Familiarity with the passage
...
## The things that are you, not the test

Having accounted for design, some variance is genuinely yours:
...
1. **Pick one test and stay with it.** Cross-site comparison is not meaningful.
2. **Use unfamiliar text**, ideally prose with punctuation.
3. **Run at least sixty seconds.** Two minutes if you want a working figure.
4. **Test three times across different days** and use the **median**, not the best.
5. **Record accuracy and raw speed alongside net speed.** The gap between raw and net is the most diagnostic thing a test gives you.

The median across days removes the two largest sources of noise: how alert you are, and the luck of the passage. Full protocol in [how to test your typing speed accurately](/blog/how-to-test-typing-speed).

## What this means for benchmarks

It should make you sceptical of any published average.
...
None is more accurate than the others; they measure slightly different things. The most *useful* test for planning is one using unfamiliar prose with punctuation, running at least a minute, reporting net speed and accuracy separately.

### Why is my score so much higher on 15-second tests?

Because a burst is being extrapolated. You can exceed your sustainable pace briefly. The one-minute figure is a better guide to real work and the two-minute figure better still.
...
For tracking progress, yes. Consistency is what makes the comparison meaningful. If the site reuses passages, be aware that some of your improvement is familiarity.

### Do employer typing tests differ?

Usually, and in the harder direction: business prose with full punctuation, three to five minutes, on an unfamiliar keyboard, sometimes with blocking on errors. Practise under those conditions rather than on short word-list tests.

### Why does my real-world typing feel slower than my test score?

Because tests use prepared text you are copying, and real work involves unfamiliar words, names, formatting, thinking and interruptions. A gap is normal. A very large gap usually means you have been practising on word lists and working in punctuated prose.

## Get one number and keep it

Take a one-minute test on unfamiliar prose, at your ordinary pace, three times this week. Use the middle result and write down the accuracy alongside it.
...
The strongest argument for teaching typing in schools is no longer vocational. It is that written work is increasingly produced and sometimes assessed on a keyboard, and a pupil who types slowly is penalised on a task designed to measure something else. That is a fairness argument, it has become harder to dismiss as digital assessment has spread, and it does not depend on any prediction about the future of work.
...
Unlike most arguments about digital skills, this one is measurable and immediate. It does not require anyone to guess what jobs will exist in fifteen years.
...
Ages seven to nine is where this is cheapest: hands are usually big enough, and a two-finger habit is months old rather than years old. Schools are one of the few institutions positioned to catch a whole cohort inside that window.

Left to chance, most children arrive at secondary school with an entrenched two-finger habit that is harder to replace and comes with an opinion attached.

## The case against

Taking the objections seriously, because most of them have something in them.

### Curriculum time is finite

The real objection. Fifteen minutes a day is fifteen minutes not spent on something else, and every subject has a claim.

The counter is that the cost is genuinely small and non-recurring, and that some of it can sit inside existing computing or literacy time rather than being additional. But "we have no time" is an honest constraint rather than an excuse.

### It may not be needed in future

Voice input has improved a great deal. It is plausible that the amount of typing people do will fall.

Against that: voice is poor for editing, unusable in a classroom of thirty, awkward for anything structured, and irrelevant for maths, code and spreadsheets. Keyboards have also outlasted several confident predictions of their obsolescence. This is a bet either way, and it is a cheap bet in one direction.
...
True, and it is an argument *for* school provision rather than against it. A skill left to be acquired at home is acquired unevenly, and the children who miss out are predictable.

## What a realistic school programme looks like

The evidence-informed version, stripped of ambition:
...
Being straight about this, because both sides of the argument tend to overclaim.
...
## What happens where schools do not teach it
...
### Is typing still taught in schools?

Provision varies widely by country and school, and in many systems it is not a curriculum requirement. Where it is taught it is often a short unit within computing rather than sustained daily practice, which is the arrangement least likely to work.

### At what age should schools start?

Around seven to nine for most children, subject to hand size. Earlier tends to teach a hand-shifting habit; later means replacing an entrenched one.

### How long does a school programme need to be?

Ten to fifteen minutes daily for one to two terms is enough for most children to reach touch typing. A weekly lesson for a year is considerably less effective for the same total time.

### Should typing be assessed?

Technique and accuracy, informally. Speed targets tend to produce speed-chasing, which rehearses errors. If a number is used at all, it should be a thermometer rather than a grade.

### Does teaching typing improve writing?

There is a plausible mechanism and the direct evidence is limited. The defensible claim is narrower: it removes a constraint on keyboard-produced writing. Schools should be wary of programmes claiming more.
...
If you are deciding whether to run a programme, the practical shape is: one term, ten minutes daily, Years 3 to 5, hands covered, accuracy over speed, technique assessed informally.

The wider case for parents whose schools do not offer this is in [typing for kids](/blog/typing-for-kids-guide-for-parents), and the home-education version in [typing for homeschoolers](/blog/typing-for-homeschoolers).

KeyTopia's [schools page](/typing-for-schools) sets out how classroom use works without pupil email addresses or accounts, which is usually the first practical question a school asks.
`,
...
They feel like one activity and they are not, which is why general typing practice often fails to change how a working day feels.
...
### Documents and long-form writing
...
**Characteristics:** short, fast, conversational, often while doing something else.
...
## The five changes that help most

In order of return, and only the fourth is typing speed.
...
If your raw speed is well above your net speed, errors are your constraint. Each one costs several keystrokes and a broken rhythm, and in correspondence it also costs the re-read.

This is typically a two-week fix with a visible result, which makes it the best return available to most people. See [how to improve typing accuracy](/blog/improve-typing-accuracy).

### 3. Learn six keyboard shortcuts

Worth more than ten extra words per minute for most people, and it takes an afternoon.

The six that matter across nearly every application:

- **Delete the previous word** rather than holding backspace
- **Move by word** left and right
...
## The specific stalls in work typing
...
**Numbers in prose.** Dates, figures, percentages, times. Long reaches, rarely drilled, and they arrive inside sentences rather than in a separate block.

**Brackets and quotation marks.** Little-finger territory, shifted, and common in business writing.

## Endurance, which nobody trains
...
Not a typing problem, and worth naming because it is often the actual answer.

Typing speed is measured in continuous conditions. A working day is not continuous, and the cost of resuming after an interruption dwarfs the difference between 45 and 65 words per minute. If your day is fragmented, protecting a block of it will do more than any amount of typing practice.

## A six-week plan for a working adult

| Weeks | What you do | Fifteen minutes a day |
|---|---|---|
| 1–2 | Stop looking, if you still do | Hands covered, home row, then letters |
| 3 | Accuracy | 80% pace, real prose, no corrections |
| 4 | Work-specific stalls | Capitals, brackets, numbers, email addresses |
| 5 | Weak transitions | Your own slowest pairs, measured not guessed |
| 6 | Endurance | Five minutes continuous, watching what degrades |

Keep practice separate from real work for the first fortnight. Trying to switch everything at once means hitting a deadline in week one and reverting, which is how most working adults' attempts end. The staging is in [learning touch typing as an adult](/blog/learn-touch-typing-as-an-adult).

## Common questions

### What typing speed do I need for office work?

Around 50 to 60 words per minute removes typing as a constraint for essentially all office work. Below 40 you will notice it during long documents and live note-taking.

### Will typing faster make me more productive?

Somewhat, and less than the arithmetic suggests, because thinking rather than typing is usually the constraint. The larger benefit is that typing stops competing for attention, which shows up as less fatigue rather than as saved minutes.

### Should I use text expansion or templates?

Yes, for anything you type more than weekly. Typing a repeated paragraph faster is optimising the wrong thing.

### Is voice dictation worth it at work?

For first drafts and long messages, often yes. For editing, structured documents, spreadsheets, code, and anywhere within earshot of colleagues, no. It reduces typing without replacing it.

### I type 45 wpm. Is that holding me back?

Probably slightly, for long documents and live notes, and probably not for email. Check two things first: whether you look at the keyboard, and whether your accuracy is above 95%. Either of those is a bigger and cheaper win than raw speed.
