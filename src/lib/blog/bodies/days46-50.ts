/** Articles for days 46-50. */
export const DAYS_46_50: Record<string, string> = {
  'mechanical-vs-membrane-keyboards': `
Switch type matters far less to your typing speed than three things almost nobody argues about: whether the layout is one you know without hunting, whether key travel is consistent across the board, and whether the keyboard sits at a height and angle you can work at. A mechanical keyboard may well be more pleasant to type on, and pleasantness over eight hours a day is a real benefit. It is not a speed upgrade, and the honest evidence for one is thin.
...
In order, and note where switch type appears.
...
**Practical rule: the worst keyboard you know beats the best keyboard you do not.**
...
Larger effect than the switches, and free to fix.

Almost every keyboard has feet at the back that tilt it towards you, which bends your wrists upwards. Leave them folded down. A flat or slightly negative tilt is better.

The desk height matters more than the keyboard: forearms should be roughly level, elbows at about a right angle. A thick mechanical keyboard raises the typing surface by a couple of centimetres, which on an already-high desk makes things worse rather than better. [Typing posture](/blog/typing-posture) covers the setup.

### 4. Actuation force and travel

Lighter switches require less work per keystroke, and over thousands of keystrokes that matters for fatigue. Shorter travel means the key registers sooner.

Both effects are real and small. They are also personal: some people type faster on short-travel laptop keys and some feel they are typing on a table.

### 5. Switch type itself
...
Be sceptical of any speed claim that does not account for that variation, and of any comparison where the participant knew which keyboard they were using and had a preference.

## The comparison, honestly

| | Mechanical | Membrane / scissor |
|---|---|---|
| Typing speed | No reliable evidence of an advantage | Same |
| Consistency across keys | Usually better | Varies hugely by price |
| Typing effort | Often lower, with light switches | Varies |
| Noise | Usually louder, sometimes much | Usually quiet |
| Cost | Higher | Lower |
| Repairability | Individual switches replaceable | Usually disposable |
| Portability | Heavier, thicker | Thin and light |
| Feel | Preferred by many who type a lot | Preferred by some, especially laptop users |

The first row is the one people buy for and the one with the least support.

## When a mechanical keyboard is a good idea
...
Perfectly fine for touch typing. Short travel, and the home row and the F and J ridges are exactly where they should be.
...
There is no reliable evidence that they do. They may make typing more comfortable, and comfort matters over long sessions, but claims of a speed advantage are not well supported and the differences enthusiasts report are usually within normal day-to-day variation.
...
Cheap ones can be, because of inconsistent key feel rather than the mechanism. Good scissor-switch keyboards are excellent, which is why plenty of fast typists work happily on laptops.
...
If your current one is genuinely uncomfortable or inconsistent, yes. Otherwise, the money and attention are better spent on technique: not looking at the keys, correct finger assignments, and targeted practice are each worth more than any board. [How to type faster](/blog/how-to-type-faster) covers what actually moves the number.

## Test it on your own keyboard
...
The arithmetic is worth doing, because it sets expectations honestly.

| Piece of work | At 30 wpm | At 50 wpm | Difference |
|---|---|---|---|
| 500-word homework | 17 min | 10 min | 7 min |
...
## The two benefits that matter more
...
## Where typing speed genuinely limits homework

Being specific is more useful than general claims.
...
**Anything typed at the last minute.** Which is most homework, realistically.

## Where it does not

**Maths, problem sets and short answers.** Not keyboard-bound.

**Research and reading**, which is most of the time spent on a good essay.

**Anything above about 70 words per minute.** At that point the student is waiting for their next sentence, not for their hands.
...
## Things that save more homework time than typing speed

Worth saying, because several are nearly free.

**Learn six shortcuts.** Word-delete, move-by-word, select-word, paste-without-formatting, search, switch-window. Worth more to most students than ten extra words per minute, and it takes an afternoon.

**Learn your reference manager's insert-citation shortcut.** For anything with a bibliography this saves more time than any typing improvement.
...
**Do learn** during a normal term, fifteen minutes a day for six weeks. It is a finite project that then stays learned.

**Do not learn** in the term before major exams, or during a heavy coursework period. Replacing your typing method makes you slower for two to three weeks, and that dip should not land on your deadlines.

If you are close to finals, use what you have and start in the holidays.
...
Around 40 words per minute is workable for homework and essays; 50 to 60 is comfortable and covers live note-taking. Above 70 it stops mattering for schoolwork.

### Is it worth learning touch typing during exam years?

Yes, but time it carefully. Six weeks in a quieter term, not the month before finals. The temporary slowdown is real.
...
`,
  ...
  'how-typing-apps-measure-progress': `
Under a typing app's headline score there are usually five separate measurements: speed, accuracy, per-key timing, per-transition timing and consistency. Only the first two are normally shown, and the last three are where anything actionable lives. Knowing what each one is and how it is calculated tells you which number to chase and which to ignore.
...
- **Gross or raw speed** counts every keystroke, errors included.
- **Net speed** accounts for errors, either by subtracting a penalty per uncorrected mistake or by counting only characters correct in the final text.

The gap between them is the most diagnostic single figure a typing app produces, and it is often not displayed. A gap of a few words per minute is normal; fifteen means errors are your binding constraint. Full explanation in [what does WPM mean](/blog/what-does-wpm-mean).

### Accuracy

Normally the proportion of keystrokes correct on the first attempt:
...
How long each key takes, measured from the previous keystroke.

This is where diagnosis starts. An average tells you that you type at 58 words per minute; per-key timing tells you that your Y and your semicolon are twice as slow as everything else, which is usually a wrong finger assignment or a reach that never became automatic.

Good apps report this as a deviation from your own average rather than in absolute milliseconds, because your baseline is what makes a key slow or not.
...
**Which finger pressed the key.** Almost no software can tell. A keyboard reports that D was pressed, not that you pressed it with your index finger instead of your middle.
...
**Best-ever score.** Motivating and misleading. Your best result is a story about one good minute, and it ratchets upwards without ever coming down, which makes it useless for noticing that you have got worse.
...
## How adaptive practice uses the data
...
Step two is the one that separates genuine adaptive practice from something that sends you to drill Q and Z because they are technically your slowest keys. Step five is what makes it adaptive rather than merely personalised. More in [adaptive typing lessons](/blog/adaptive-typing-lessons).

## What to be sceptical of

**"Adaptive" that means difficulty scaling.** Speeding up as you improve responds to your overall level, not your specific weaknesses.

**Weak-key claims from very little data.** Distinguishing a real weakness from a tired session needs a few thousand keystrokes, not fifteen seconds.
...
If you want to know whether you are improving:

| Watch | Ignore |
|---|---|
| Median net speed on unfamiliar text | Best-ever score |
| Accuracy at your working pace | Accuracy at a careful pace |
| Consistency | Peak burst speed |
| Your slowest transitions | Your slowest rare letters |
| Five-minute figure | Fifteen-second figure |

The right-hand column is what most apps put on the front page, because it is more encouraging. The left-hand column is what tells you what to do.

## Common questions

### What is the most important typing metric?

The gap between your raw and net speed, because it tells you whether to train speed or accuracy. After that, per-transition timing, because it tells you exactly what to practise.
...
No. Keyboards report which key was pressed, not which finger pressed it. The app can identify that a key is slow; identifying why requires you to watch your own hands.
...
A few thousand keystrokes, which is a handful of sessions. Anything identifying your weak keys from a single short test is guessing.
...
`,
  ...
  'typing-for-homeschoolers': `
Typing is one of the easiest subjects to fit into a home education timetable, because it is one of the few where fifteen minutes a day genuinely beats an hour a week. Motor skills consolidate between sessions rather than during them, so frequency does the work. That makes it cheap to schedule, easy to assess objectively, and unusually well suited to being the thing you do first thing every morning.

## Why the daily slot matters more than the total

The single most important scheduling fact: **the same total time produces a better result spread across more sessions.**

Fifteen minutes a day beats an hour and three quarters once a week, and the gap is not small. This is one of the better-established findings in motor learning, and it means a weekly typing lesson is close to the least effective arrangement available.

Practically:

- **Ten to fifteen minutes, five days a week** is the target.
- **Attach it to something fixed.** Before maths, after breakfast, first thing. A slot removes the daily negotiation.
- **A short session on a bad day beats no session.** Five minutes keeps the chain.

## When to start

Hand size decides it, not age. Run this thirty-second check:

Ask your child to put their left-hand fingers on A S D F and their right on J K L ;, then reach up and press E with the finger resting on D.

- **Hand stays put, only the finger moves** → ready.
- **Whole hand lifts or slides** → not yet. Practising anyway teaches a hand-shifting habit that has to be removed later.

Most children pass somewhere between seven and nine. If yours does not, play letter-finding games and re-check in three months. [What age should kids learn to type](/blog/what-age-should-kids-learn-to-type) covers the age-by-age picture.

## A term-long plan

Twelve weeks, ten to fifteen minutes a day. This is enough for most children to reach genuine touch typing.

| Weeks | Focus | What you should see |
|---|---|---|
...
**Stop on time**, even mid-word, and especially on a good day.

There is a four-part session structure in [typing practice for kids](/blog/typing-practice-for-kids-routine).
...
**On targets:** school typing schemes commonly aim for a modest progression rising to somewhere around 15 to 25 words per minute by the end of primary. Those are curriculum conventions rather than measurements of children in general, so use them as a direction of travel and not as a verdict. [Typing speed for kids by age](/blog/typing-speed-for-kids-by-age) sets out where those numbers come from and what they are worth.

## Fitting it alongside everything else
...
**It works for mixed ages, badly.** Each child needs their own level and their own weak keys, so a shared session mostly means one child waiting. Better to give each their own ten minutes.
...
**"We keep missing days."** Move the slot earlier. Typing done first thing survives; typing done "later" does not.

## Common questions

### How much typing should a homeschooler do each day?

Ten to fifteen minutes, five days a week, for about a term. More than twenty minutes a day produces diminishing returns at this age and makes the habit harder to sustain.
...
If you do not touch type yourself, yes. It makes the awkward fortnight shared rather than imposed, and the person doing the correcting has recently been bad at it too.

### What about teenagers who already type with two fingers?

Closer to the adult process: ring-fence practice from real work for the first fortnight, expect a longer dip, and fix one habit at a time. [Learning touch typing as an adult](/blog/learn-touch-typing-as-an-adult) applies more than the children's advice.

## Start on Monday

Run the reach test. If they pass, put ten minutes in the timetable before the first proper subject, find a tea towel, and do home row only for the first fortnight.

Then leave their project work alone for a month while the new habit builds.

KeyTopia's [children's world](/typing-for-kids) handles the letter sequencing and tracks which keys each child is actually weak on, and the wider parent's guide is in [typing for kids](/blog/typing-for-kids-guide-for-parents).
`,
...
In 2014, Pam Mueller and Daniel Oppenheimer published "The Pen Is Mightier Than the Keyboard" in *Psychological Science*. Across several experiments, students watched lectures and took notes either by hand or on a laptop, then answered questions afterwards.
...
In 2019, Kayla Morehead, John Dunlosky and Katherine Rawson published a replication and extension in *Educational Psychology Review*. Working with larger samples, they did not reproduce the central findings. Differences between longhand and laptop note-taking on comprehension measures were not reliably found.

They did replicate the more mundane part: laptop note-takers do write more, and more verbatim. What did not hold up was the claim that this translates into worse understanding.

This is a normal and healthy scientific outcome, and it is also the part that rarely travels with the headline. A finding that has failed to replicate is not thereby proven false, but it should be held much more loosely than its citation count implies.

**The honest current position:** whether typing notes is worse than handwriting them for comprehension is genuinely unsettled.

## What is better supported

Two related findings sit on firmer ground.
...
Learn to handwrite. The evidence for handwriting's role in early letter learning is the strongest part of this whole area, and nothing about typing instruction requires displacing it.

Learning to type as well, from around seven to nine, is not in competition with that. They are different skills used for different things, and a child benefits from both. [Why touch typing matters for kids](/blog/why-touch-typing-matters-for-kids) covers the case for the second.
...
For essays and long-form work, the case for typing is not really contested. Revision is where most of the quality in a long piece comes from, and revising by hand is expensive enough that people do less of it.

## The arguments that do not hold up

A few claims circulate in both directions and deserve retiring.

**"Handwriting is always better for learning."** Overstated well beyond what the evidence supports, and it leans on a study whose central finding did not replicate.

**"Typing is always better because it is faster."** Speed is not the goal in note-taking. Faster capture can mean less processing.

**"Handwriting is obsolete."** It is not, and the early-letter-learning evidence is a real reason to keep teaching it.

**"Children should not learn to type until their handwriting is fluent."** There is no evidence that learning one impairs the other, and the two use different motor systems and different materials.

## Common questions

### Is it better to take notes by hand or on a laptop?

Genuinely unsettled. The famous study favouring handwriting did not replicate. What is better supported is that summarising in your own words beats verbatim transcription, whichever medium you use.

### Does handwriting help you remember better?

The specific claim about lecture comprehension is in doubt. The claim about young children learning letter shapes is better supported. Those are different questions and are frequently conflated.
...
There is no reliable evidence that it will. How you take the notes matters more: summarise rather than transcribe, and reorganise them afterwards.

### What about drawing and diagrams?

An honest advantage of paper, and one this debate usually skips. Sketching a diagram, an arrow between two ideas or a quick graph is far faster by hand than in most software. Many people use both for exactly this reason.
